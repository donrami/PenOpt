...
export function GetMeshInfo():Promise<main.meshInfo>;

export function GetScannerPresets():Promise<string>;

export function GetVertexBuffer():Promise<Array<number>>;

export function LoadMeshFromBytes(arg1:string,arg2:Array<number>):Promise<main.meshInfo>;

export function PickAndLoadMesh():Promise<main.meshInfo>;
