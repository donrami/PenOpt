...
`].filter(Qi).join(`
`)),a=ka(a),a=wl(a,t),a=Rl(a,t),o=ka(o),o=wl(o,t),o=Rl(o,t),a=Cl(a),o=Cl(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+d);const E=S+f+a,T=S+d+o,L=El(s,s.VERTEX_SHADER,E),A=El(s,s.FRAGMENT_SHADER,T);s.attachShader(v,L),s.attachShader(v,A),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function C(R){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(v)||"",H=s.getShaderInfoLog(L)||"",q=s.getShaderInfoLog(A)||"",U=N.trim(),k=H.trim(),G=q.trim();let ee=!0,te=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(ee=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,L,A);else{const de=Al(s,L,"vertex"),Y=Al(s,A,"fragment");Ye("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
