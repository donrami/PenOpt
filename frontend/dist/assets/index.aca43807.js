...
`)}const Nm={[zl]:"Linear",[Gl]:"Reinhard",[Hl]:"Cineon",[Ya]:"ACESFilmic",[Vl]:"AgX",[Wl]:"Neutral",[kl]:"Custom"};function Fm(i,e){const t=Nm[e];return t===void 0?(Le("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Bs=new I;function Om(){qe.getLuminanceCoefficients(Bs);const i=Bs.x.toFixed(4),e=Bs.y.toFixed(4),t=Bs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Qi).join(`
`)),a=ka(a),a=Al(a,t),a=wl(a,t),o=ka(o),o=Al(o,t),o=wl(o,t),a=Rl(a),o=Rl(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+d);const T=M+p+a,A=M+d+o,P=bl(s,s.VERTEX_SHADER,T),b=bl(s,s.FRAGMENT_SHADER,A);s.attachShader(S,P),s.attachShader(S,b),t.index0AttributeName!==void 0?s.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function C(R){if(i.debug.checkShaderErrors){const B=s.getProgramInfoLog(S)||"",X=s.getShaderInfoLog(P)||"",Y=s.getShaderInfoLog(b)||"",N=B.trim(),H=X.trim(),G=Y.trim();let ee=!0,te=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if(ee=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,S,P,b);else{const de=Tl(s,P,"vertex"),q=Tl(s,b,"fragment");Ye("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
...
Program Info Log: `+N+`
`+de+`
`+q)}else N!==""?Le("WebGLProgram: Program Info Log:",N):(H===""||G==="")&&(te=!1);te&&(R.diagnostics={runnable:ee,programLog:N,vertexShader:{log:H,prefix:p},fragmentShader:{log:G,prefix:d}})}s.deleteShader(P),s.deleteShader(b),x=new qs(s,S),w=Gm(s,S)}let x;this.getUniforms=function(){return x===void 0&&C(this),x};let w;this.getAttributes=function(){return w===void 0&&C(this),w};let U=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return U===!1&&(U=s.getProgramParameter(S,Pm)),U},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(S),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Lm++,this.cacheKey=e,this.usedTimes=1,this.program=S,this.vertexShader=P,this.fragmentShader=b,this}let ng=0;class ig{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new sg(e),t.set(e,n)),n}}class sg{constructor(e){this.id=ng++,this.code=e,this.usedTimes=0}}function rg(i){return i===ri||i===js||i===Ks}function ag(i,e,t,n,s,r){const a=new tc,o=new ig,l=new Set,c=[],u=new Map,f=n.logarithmicDepthBuffer;let h=n.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return l.add(x),x===0?"uv":`uv${x}`}function S(x,w,U,R,B,X){const Y=R.fog,N=B.geometry,H=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?R.environment:null,G=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,ee=e.get(x.envMap||H,G),te=!!ee&&ee.mapping===rr?ee.image.height:null,de=m[x.type];x.precision!==null&&(h=n.getMaxPrecision(x.precision),h!==x.precision&&Le("WebGLProgram.getParameters:",x.precision,"not supported, using",h,"instead."));const q=N.morphAttributes.position||N.morphAttributes.normal||N.morphAttributes.color,Q=q!==void 0?q.length:0;let ye=0;N.morphAttributes.position!==void 0&&(ye=1),N.morphAttributes.normal!==void 0&&(ye=2),N.morphAttributes.color!==void 0&&(ye=3);let ke,Ee,Z,he;if(de){const Fe=on[de];ke=Fe.vertexShader,Ee=Fe.fragmentShader}else ke=x.vertexShader,Ee=x.fragmentShader,o.update(x),Z=o.getVertexShaderID(x),he=o.getFragmentShaderID(x);const se=i.getRenderTarget(),Ae=i.state.buffers.depth.getReversed(),De=B.isInstancedMesh===!0,Pe=B.isBatchedMesh===!0,st=!!x.map,ze=!!x.matcap,Ze=!!ee,je=!!x.aoMap,Ue=!!x.lightMap,Je=!!x.bumpMap,ht=!!x.normalMap,zt=!!x.displacementMap,F=!!x.emissiveMap,St=!!x.metalnessMap,Xe=!!x.roughnessMap,ot=x.anisotropy>0,fe=x.clearcoat>0,ft=x.dispersion>0,E=x.iridescence>0,_=x.sheen>0,z=x.transmission>0,$=ot&&!!x.anisotropyMap,ie=fe&&!!x.clearcoatMap,re=fe&&!!x.clearcoatNormalMap,ue=fe&&!!x.clearcoatRoughnessMap,j=E&&!!x.iridescenceMap,J=E&&!!x.iridescenceThicknessMap,_e=_&&!!x.sheenColorMap,Me=_&&!!x.sheenRoughnessMap,le=!!x.specularMap,ae=!!x.specularColorMap,Ie=!!x.specularIntensityMap,Be=z&&!!x.transmissionMap,$e=z&&!!x.thicknessMap,D=!!x.gradientMap,oe=!!x.alphaMap,K=x.alphaTest>0,xe=!!x.alphaHash,ce=!!x.extensions;let ne=un;x.toneMapped&&(se===null||se.isXRRenderTarget===!0)&&(ne=i.toneMapping);const Te={shaderID:de,shaderType:x.type,shaderName:x.name,vertexShader:ke,fragmentShader:Ee,defines:x.defines,customVertexShaderID:Z,customFragmentShaderID:he,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:h,batching:Pe,batchingColor:Pe&&B._colorsTexture!==null,instancing:De,instancingColor:De&&B.instanceColor!==null,instancingMorph:De&&B.morphTexture!==null,outputColorSpace:se===null?i.outputColorSpace:se.isXRRenderTarget===!0?se.texture.colorSpace:qe.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:st,matcap:ze,envMap:Ze,envMapMode:Ze&&ee.mapping,envMapCubeUVHeight:te,aoMap:je,lightMap:Ue,bumpMap:Je,normalMap:ht,displacementMap:zt,emissiveMap:F,normalMapObjectSpace:ht&&x.normalMapType===xh,normalMapTangentSpace:ht&&x.normalMapType===Oa,packedNormalMap:ht&&x.normalMapType===Oa&&rg(x.normalMap.format),metalnessMap:St,roughnessMap:Xe,anisotropy:ot,anisotropyMap:$,clearcoat:fe,clearcoatMap:ie,clearcoatNormalMap:re,clearcoatRoughnessMap:ue,dispersion:ft,iridescence:E,iridescenceMap:j,iridescenceThicknessMap:J,sheen:_,sheenColorMap:_e,sheenRoughnessMap:Me,specularMap:le,specularColorMap:ae,specularIntensityMap:Ie,transmission:z,transmissionMap:Be,thicknessMap:$e,gradientMap:D,opaque:x.transparent===!1&&x.blending===Pi&&x.alphaToCoverage===!1,alphaMap:oe,alphaTest:K,alphaHash:xe,combine:x.combine,mapUv:st&&g(x.map.channel),aoMapUv:je&&g(x.aoMap.channel),lightMapUv:Ue&&g(x.lightMap.channel),bumpMapUv:Je&&g(x.bumpMap.channel),normalMapUv:ht&&g(x.normalMap.channel),displacementMapUv:zt&&g(x.displacementMap.channel),emissiveMapUv:F&&g(x.emissiveMap.channel),metalnessMapUv:St&&g(x.metalnessMap.channel),roughnessMapUv:Xe&&g(x.roughnessMap.channel),anisotropyMapUv:$&&g(x.anisotropyMap.channel),clearcoatMapUv:ie&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:re&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ue&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:j&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:J&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:_e&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:Me&&g(x.sheenRoughnessMap.channel),specularMapUv:le&&g(x.specularMap.channel),specularColorMapUv:ae&&g(x.specularColorMap.channel),specularIntensityMapUv:Ie&&g(x.specularIntensityMap.channel),transmissionMapUv:Be&&g(x.transmissionMap.channel),thicknessMapUv:$e&&g(x.thicknessMap.channel),alphaMapUv:oe&&g(x.alphaMap.channel),vertexTangents:!!N.attributes.tangent&&(ht||ot),vertexNormals:!!N.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!N.attributes.color&&N.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!N.attributes.uv&&(st||oe),fog:!!Y,useFog:x.fog===!0,fogExp2:!!Y&&Y.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||N.attributes.normal===void 0&&ht===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:Ae,skinning:B.isSkinnedMesh===!0,morphTargets:N.morphAttributes.position!==void 0,morphNormals:N.morphAttributes.normal!==void 0,morphColors:N.morphAttributes.color!==void 0,morphTargetsCount:Q,morphTextureStride:ye,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:X.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&U.length>0,shadowMapType:i.shadowMap.type,toneMapping:ne,decodeVideoTexture:st&&x.map.isVideoTexture===!0&&qe.getTransfer(x.map.colorSpace)===Qe,decodeVideoTextureEmissive:F&&x.emissiveMap.isVideoTexture===!0&&qe.getTransfer(x.emissiveMap.colorSpace)===Qe,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Qt,flipSided:x.side===Ot,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:ce&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ce&&x.extensions.multiDraw===!0||Pe)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Te.vertexUv1s=l.has(1),Te.vertexUv2s=l.has(2),Te.vertexUv3s=l.has(3),l.clear(),Te}function p(x){const w=[];if(x.shaderID?w.push(x.shaderID):(w.push(x.customVertexShaderID),w.push(x.customFragmentShaderID)),x.defines!==void 0)for(const U in x.defines)w.push(U),w.push(x.defines[U]);return x.isRawShaderMaterial===!1&&(d(w,x),M(w,x),w.push(i.outputColorSpace)),w.push(x.customProgramCacheKey),w.join()}function d(x,w){x.push(w.precision),x.push(w.outputColorSpace),x.push(w.envMapMode),x.push(w.envMapCubeUVHeight),x.push(w.mapUv),x.push(w.alphaMapUv),x.push(w.lightMapUv),x.push(w.aoMapUv),x.push(w.bumpMapUv),x.push(w.normalMapUv),x.push(w.displacementMapUv),x.push(w.emissiveMapUv),x.push(w.metalnessMapUv),x.push(w.roughnessMapUv),x.push(w.anisotropyMapUv),x.push(w.clearcoatMapUv),x.push(w.clearcoatNormalMapUv),x.push(w.clearcoatRoughnessMapUv),x.push(w.iridescenceMapUv),x.push(w.iridescenceThicknessMapUv),x.push(w.sheenColorMapUv),x.push(w.sheenRoughnessMapUv),x.push(w.specularMapUv),x.push(w.specularColorMapUv),x.push(w.specularIntensityMapUv),x.push(w.transmissionMapUv),x.push(w.thicknessMapUv),x.push(w.combine),x.push(w.fogExp2),x.push(w.sizeAttenuation),x.push(w.morphTargetsCount),x.push(w.morphAttributeCount),x.push(w.numDirLights),x.push(w.numPointLights),x.push(w.numSpotLights),x.push(w.numSpotLightMaps),x.push(w.numHemiLights),x.push(w.numRectAreaLights),x.push(w.numDirLightShadows),x.push(w.numPointLightShadows),x.push(w.numSpotLightShadows),x.push(w.numSpotLightShadowsWithMaps),x.push(w.numLightProbes),x.push(w.shadowMapType),x.push(w.toneMapping),x.push(w.numClippingPlanes),x.push(w.numClipIntersection),x.push(w.depthPacking)}function M(x,w){a.disableAll(),w.instancing&&a.enable(0),w.instancingColor&&a.enable(1),w.instancingMorph&&a.enable(2),w.matcap&&a.enable(3),w.envMap&&a.enable(4),w.normalMapObjectSpace&&a.enable(5),w.normalMapTangentSpace&&a.enable(6),w.clearcoat&&a.enable(7),w.iridescence&&a.enable(8),w.alphaTest&&a.enable(9),w.vertexColors&&a.enable(10),w.vertexAlphas&&a.enable(11),w.vertexUv1s&&a.enable(12),w.vertexUv2s&&a.enable(13),w.vertexUv3s&&a.enable(14),w.vertexTangents&&a.enable(15),w.anisotropy&&a.enable(16),w.alphaHash&&a.enable(17),w.batching&&a.enable(18),w.dispersion&&a.enable(19),w.batchingColor&&a.enable(20),w.gradientMap&&a.enable(21),w.packedNormalMap&&a.enable(22),w.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reversedDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.decodeVideoTextureEmissive&&a.enable(20),w.alphaToCoverage&&a.enable(21),w.numLightProbeGrids>0&&a.enable(22),x.push(a.mask)}function T(x){const w=m[x.type];let U;if(w){const R=on[w];U=Mu.clone(R.uniforms)}else U=x.uniforms;return U}function A(x,w){let U=u.get(w);return U!==void 0?++U.usedTimes:(U=new tg(i,w,x,s),c.push(U),u.set(w,U)),U}function P(x){if(--x.usedTimes===0){const w=c.indexOf(x);c[w]=c[c.length-1],c.pop(),u.delete(x.cacheKey),x.destroy()}}function b(x){o.remove(x)}function C(){o.dispose()}return{getParameters:S,getProgramCacheKey:p,getUniforms:T,acquireProgram:A,releaseProgram:P,releaseShaderCache:b,programs:c,dispose:C}}function og(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function lg(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function Pl(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Ll(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h){let m=0;return h.isInstancedMesh&&(m+=2),h.isSkinnedMesh&&(m+=1),m}function o(h,m,g,S,p,d){let M=i[e];return M===void 0?(M={id:h.id,object:h,geometry:m,material:g,materialVariant:a(h),groupOrder:S,renderOrder:h.renderOrder,z:p,group:d},i[e]=M):(M.id=h.id,M.object=h,M.geometry=m,M.material=g,M.materialVariant=a(h),M.groupOrder=S,M.renderOrder=h.renderOrder,M.z=p,M.group=d),e++,M}function l(h,m,g,S,p,d){const M=o(h,m,g,S,p,d);g.transmission>0?n.push(M):g.transparent===!0?s.push(M):t.push(M)}function c(h,m,g,S,p,d){const M=o(h,m,g,S,p,d);g.transmission>0?n.unshift(M):g.transparent===!0?s.unshift(M):t.unshift(M)}function u(h,m){t.length>1&&t.sort(h||lg),n.length>1&&n.sort(m||Pl),s.length>1&&s.sort(m||Pl)}function f(){for(let h=e,m=i.length;h<m;h++){const g=i[h];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:f,sort:u}}function cg(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Ll,i.set(n,[a])):s>=r.length?(a=new Ll,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function hg(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new I,color:new He};break;case"SpotLight":t={position:new I,direction:new I,color:new He,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new I,color:new He,distance:0,decay:0};break;case"HemisphereLight":t={direction:new I,skyColor:new He,groundColor:new He};break;case"RectAreaLight":t={color:new He,position:new I,halfWidth:new I,halfHeight:new I};break}return i[e.id]=t,t}}}function ug(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let dg=0;function fg(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function pg(i){const e=new hg,t=ug(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new I);const s=new I,r=new dt,a=new dt;function o(c){let u=0,f=0,h=0;for(let w=0;w<9;w++)n.probe[w].set(0,0,0);let m=0,g=0,S=0,p=0,d=0,M=0,T=0,A=0,P=0,b=0,C=0;c.sort(fg);for(let w=0,U=c.length;w<U;w++){const R=c[w],B=R.color,X=R.intensity,Y=R.distance;let N=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===ri?N=R.shadow.map.texture:N=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)u+=B.r*X,f+=B.g*X,h+=B.b*X;else if(R.isLightProbe){for(let H=0;H<9;H++)n.probe[H].addScaledVector(R.sh.coefficients[H],X);C++}else if(R.isDirectionalLight){const H=e.get(R);if(H.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const G=R.shadow,ee=t.get(R);ee.shadowIntensity=G.intensity,ee.shadowBias=G.bias,ee.shadowNormalBias=G.normalBias,ee.shadowRadius=G.radius,ee.shadowMapSize=G.mapSize,n.directionalShadow[m]=ee,n.directionalShadowMap[m]=N,n.directionalShadowMatrix[m]=R.shadow.matrix,M++}n.directional[m]=H,m++}else if(R.isSpotLight){const H=e.get(R);H.position.setFromMatrixPosition(R.matrixWorld),H.color.copy(B).multiplyScalar(X),H.distance=Y,H.coneCos=Math.cos(R.angle),H.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),H.decay=R.decay,n.spot[S]=H;const G=R.shadow;if(R.map&&(n.spotLightMap[P]=R.map,P++,G.updateMatrices(R),R.castShadow&&b++),n.spotLightMatrix[S]=G.matrix,R.castShadow){const ee=t.get(R);ee.shadowIntensity=G.intensity,ee.shadowBias=G.bias,ee.shadowNormalBias=G.normalBias,ee.shadowRadius=G.radius,ee.shadowMapSize=G.mapSize,n.spotShadow[S]=ee,n.spotShadowMap[S]=N,A++}S++}else if(R.isRectAreaLight){const H=e.get(R);H.color.copy(B).multiplyScalar(X),H.halfWidth.set(R.width*.5,0,0),H.halfHeight.set(0,R.height*.5,0),n.rectArea[p]=H,p++}else if(R.isPointLight){const H=e.get(R);if(H.color.copy(R.color).multiplyScalar(R.intensity),H.distance=R.distance,H.decay=R.decay,R.castShadow){const G=R.shadow,ee=t.get(R);ee.shadowIntensity=G.intensity,ee.shadowBias=G.bias,ee.shadowNormalBias=G.normalBias,ee.shadowRadius=G.radius,ee.shadowMapSize=G.mapSize,ee.shadowCameraNear=G.camera.near,ee.shadowCameraFar=G.camera.far,n.pointShadow[g]=ee,n.pointShadowMap[g]=N,n.pointShadowMatrix[g]=R.shadow.matrix,T++}n.point[g]=H,g++}else if(R.isHemisphereLight){const H=e.get(R);H.skyColor.copy(R.color).multiplyScalar(X),H.groundColor.copy(R.groundColor).multiplyScalar(X),n.hemi[d]=H,d++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=pe.LTC_FLOAT_1,n.rectAreaLTC2=pe.LTC_FLOAT_2):(n.rectAreaLTC1=pe.LTC_HALF_1,n.rectAreaLTC2=pe.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=f,n.ambient[2]=h;const x=n.hash;(x.directionalLength!==m||x.pointLength!==g||x.spotLength!==S||x.rectAreaLength!==p||x.hemiLength!==d||x.numDirectionalShadows!==M||x.numPointShadows!==T||x.numSpotShadows!==A||x.numSpotMaps!==P||x.numLightProbes!==C)&&(n.directional.length=m,n.spot.length=S,n.rectArea.length=p,n.point.length=g,n.hemi.length=d,n.directionalShadow.length=M,n.directionalShadowMap.length=M,n.pointShadow.length=T,n.pointShadowMap.length=T,n.spotShadow.length=A,n.spotShadowMap.length=A,n.directionalShadowMatrix.length=M,n.pointShadowMatrix.length=T,n.spotLightMatrix.length=A+P-b,n.spotLightMap.length=P,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=C,x.directionalLength=m,x.pointLength=g,x.spotLength=S,x.rectAreaLength=p,x.hemiLength=d,x.numDirectionalShadows=M,x.numPointShadows=T,x.numSpotShadows=A,x.numSpotMaps=P,x.numLightProbes=C,n.version=dg++)}function l(c,u){let f=0,h=0,m=0,g=0,S=0;const p=u.matrixWorldInverse;for(let d=0,M=c.length;d<M;d++){const T=c[d];if(T.isDirectionalLight){const A=n.directional[f];A.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(p),f++}else if(T.isSpotLight){const A=n.spot[m];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(p),A.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(p),m++}else if(T.isRectAreaLight){const A=n.rectArea[g];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(p),a.identity(),r.copy(T.matrixWorld),r.premultiply(p),a.extractRotation(r),A.halfWidth.set(T.width*.5,0,0),A.halfHeight.set(0,T.height*.5,0),A.halfWidth.applyMatrix4(a),A.halfHeight.applyMatrix4(a),g++}else if(T.isPointLight){const A=n.point[h];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(p),h++}else if(T.isHemisphereLight){const A=n.hemi[S];A.direction.setFromMatrixPosition(T.matrixWorld),A.direction.transformDirection(p),S++}}}return{setup:o,setupView:l,state:n}}function Dl(i){const e=new pg(i),t=[],n=[],s=[];function r(h){f.camera=h,t.length=0,n.length=0,s.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function l(h){s.push(h)}function c(){e.setup(t)}function u(h){e.setupView(t,h)}const f={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:f,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function mg(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Dl(i),e.set(s,[o])):r>=a.length?(o=new Dl(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const gg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class Ag{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new cc(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new gn({vertexShader:Eg,fragmentShader:Tg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ut(new Bi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class wg extends Yn{constructor(e,t){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,m=null,g=null;const S=typeof XRWebGLBinding<"u",p=new Ag,d={},M=t.getContextAttributes();let T=null,A=null;const P=[],b=[],C=new Ce;let x=null;const w=new jt;w.viewport=new mt;const U=new jt;U.viewport=new mt;const R=[w,U],B=new Iu;let X=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let he=P[Z];return he===void 0&&(he=new vr,P[Z]=he),he.getTargetRaySpace()},this.getControllerGrip=function(Z){let he=P[Z];return he===void 0&&(he=new vr,P[Z]=he),he.getGripSpace()},this.getHand=function(Z){let he=P[Z];return he===void 0&&(he=new vr,P[Z]=he),he.getHandSpace()};function N(Z){const he=b.indexOf(Z.inputSource);if(he===-1)return;const se=P[he];se!==void 0&&(se.update(Z.inputSource,Z.frame,c||a),se.dispatchEvent({type:Z.type,data:Z.inputSource}))}function H(){s.removeEventListener("select",N),s.removeEventListener("selectstart",N),s.removeEventListener("selectend",N),s.removeEventListener("squeeze",N),s.removeEventListener("squeezestart",N),s.removeEventListener("squeezeend",N),s.removeEventListener("end",H),s.removeEventListener("inputsourceschange",G);for(let Z=0;Z<P.length;Z++){const he=b[Z];he!==null&&(b[Z]=null,P[Z].disconnect(he))}X=null,Y=null,p.reset();for(const Z in d)delete d[Z];e.setRenderTarget(T),m=null,h=null,f=null,s=null,A=null,Ee.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){r=Z,n.isPresenting===!0&&Le("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&Le("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return f===null&&S&&(f=new XRWebGLBinding(s,t)),f},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(T=e.getRenderTarget(),s.addEventListener("select",N),s.addEventListener("selectstart",N),s.addEventListener("selectend",N),s.addEventListener("squeeze",N),s.addEventListener("squeezestart",N),s.addEventListener("squeezeend",N),s.addEventListener("end",H),s.addEventListener("inputsourceschange",G),M.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(C),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let se=null,Ae=null,De=null;M.depth&&(De=M.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,se=M.stencil?ni:Cn,Ae=M.stencil?ns:mn);const Pe={colorFormat:t.RGBA8,depthFormat:De,scaleFactor:r};f=this.getBinding(),h=f.createProjectionLayer(Pe),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),A=new dn(h.textureWidth,h.textureHeight,{format:tn,type:Vt,depthTexture:new Oi(h.textureWidth,h.textureHeight,Ae,void 0,void 0,void 0,void 0,void 0,void 0,se),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const se={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,t,se),s.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),A=new dn(m.framebufferWidth,m.framebufferHeight,{format:tn,type:Vt,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Ee.setContext(s),Ee.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function G(Z){for(let he=0;he<Z.removed.length;he++){const se=Z.removed[he],Ae=b.indexOf(se);Ae>=0&&(b[Ae]=null,P[Ae].disconnect(se))}for(let he=0;he<Z.added.length;he++){const se=Z.added[he];let Ae=b.indexOf(se);if(Ae===-1){for(let Pe=0;Pe<P.length;Pe++)if(Pe>=b.length){b.push(se),Ae=Pe;break}else if(b[Pe]===null){b[Pe]=se,Ae=Pe;break}if(Ae===-1)break}const De=P[Ae];De&&De.connect(se)}}const ee=new I,te=new I;function de(Z,he,se){ee.setFromMatrixPosition(he.matrixWorld),te.setFromMatrixPosition(se.matrixWorld);const Ae=ee.distanceTo(te),De=he.projectionMatrix.elements,Pe=se.projectionMatrix.elements,st=De[14]/(De[10]-1),ze=De[14]/(De[10]+1),Ze=(De[9]+1)/De[5],je=(De[9]-1)/De[5],Ue=(De[8]-1)/De[0],Je=(Pe[8]+1)/Pe[0],ht=st*Ue,zt=st*Je,F=Ae/(-Ue+Je),St=F*-Ue;if(he.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(St),Z.translateZ(F),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),De[10]===-1)Z.projectionMatrix.copy(he.projectionMatrix),Z.projectionMatrixInverse.copy(he.projectionMatrixInverse);else{const Xe=st+F,ot=ze+F,fe=ht-St,ft=zt+(Ae-St),E=Ze*ze/ot*Xe,_=je*ze/ot*Xe;Z.projectionMatrix.makePerspective(fe,ft,E,_,Xe,ot),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function q(Z,he){he===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(he.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let he=Z.near,se=Z.far;p.texture!==null&&(p.depthNear>0&&(he=p.depthNear),p.depthFar>0&&(se=p.depthFar)),B.near=U.near=w.near=he,B.far=U.far=w.far=se,(X!==B.near||Y!==B.far)&&(s.updateRenderState({depthNear:B.near,depthFar:B.far}),X=B.near,Y=B.far),B.layers.mask=Z.layers.mask|6,w.layers.mask=B.layers.mask&-5,U.layers.mask=B.layers.mask&-3;const Ae=Z.parent,De=B.cameras;q(B,Ae);for(let Pe=0;Pe<De.length;Pe++)q(De[Pe],Ae);De.length===2?de(B,w,U):B.projectionMatrix.copy(w.projectionMatrix),Q(Z,B,Ae)};function Q(Z,he,se){se===null?Z.matrix.copy(he.matrixWorld):(Z.matrix.copy(se.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(he.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(he.projectionMatrix),Z.projectionMatrixInverse.copy(he.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=ss*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(h===null&&m===null))return l},this.setFoveation=function(Z){l=Z,h!==null&&(h.fixedFoveation=Z),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Z)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(B)},this.getCameraTexture=function(Z){return d[Z]};let ye=null;function ke(Z,he){if(u=he.getViewerPose(c||a),g=he,u!==null){const se=u.views;m!==null&&(e.setRenderTargetFramebuffer(A,m.framebuffer),e.setRenderTarget(A));let Ae=!1;se.length!==B.cameras.length&&(B.cameras.length=0,Ae=!0);for(let ze=0;ze<se.length;ze++){const Ze=se[ze];let je=null;if(m!==null)je=m.getViewport(Ze);else{const Je=f.getViewSubImage(h,Ze);je=Je.viewport,ze===0&&(e.setRenderTargetTextures(A,Je.colorTexture,Je.depthStencilTexture),e.setRenderTarget(A))}let Ue=R[ze];Ue===void 0&&(Ue=new jt,Ue.layers.enable(ze),Ue.viewport=new mt,R[ze]=Ue),Ue.matrix.fromArray(Ze.transform.matrix),Ue.matrix.decompose(Ue.position,Ue.quaternion,Ue.scale),Ue.projectionMatrix.fromArray(Ze.projectionMatrix),Ue.projectionMatrixInverse.copy(Ue.projectionMatrix).invert(),Ue.viewport.set(je.x,je.y,je.width,je.height),ze===0&&(B.matrix.copy(Ue.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),Ae===!0&&B.cameras.push(Ue)}const De=s.enabledFeatures;if(De&&De.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&S){f=n.getBinding();const ze=f.getDepthInformation(se[0]);ze&&ze.isValid&&ze.texture&&p.init(ze,s.renderState)}if(De&&De.includes("camera-access")&&S){e.state.unbindTexture(),f=n.getBinding();for(let ze=0;ze<se.length;ze++){const Ze=se[ze].camera;if(Ze){let je=d[Ze];je||(je=new cc,d[Ze]=je);const Ue=f.getCameraImage(Ze);je.sourceTexture=Ue}}}}for(let se=0;se<P.length;se++){const Ae=b[se],De=P[se];Ae!==null&&De!==void 0&&De.update(Ae,he,c||a)}ye&&ye(Z,he),he.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:he}),g=null}const Ee=new fc;Ee.setAnimationLoop(ke),this.setAnimationLoop=function(Z){ye=Z},this.dispose=function(){}}}const Rg=new dt,Mc=new Ne;Mc.set(-1,0,0,0,1,0,0,0,1);function Cg(i,e){function t(p,d){p.matrixAutoUpdate===!0&&p.updateMatrix(),d.value.copy(p.matrix)}function n(p,d){d.color.getRGB(p.fogColor.value,hc(i)),d.isFog?(p.fogNear.value=d.near,p.fogFar.value=d.far):d.isFogExp2&&(p.fogDensity.value=d.density)}function s(p,d,M,T,A){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?r(p,d):d.isMeshLambertMaterial?(r(p,d),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(r(p,d),f(p,d)):d.isMeshPhongMaterial?(r(p,d),u(p,d),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(r(p,d),h(p,d),d.isMeshPhysicalMaterial&&m(p,d,A)):d.isMeshMatcapMaterial?(r(p,d),g(p,d)):d.isMeshDepthMaterial?r(p,d):d.isMeshDistanceMaterial?(r(p,d),S(p,d)):d.isMeshNormalMaterial?r(p,d):d.isLineBasicMaterial?(a(p,d),d.isLineDashedMaterial&&o(p,d)):d.isPointsMaterial?l(p,d,M,T):d.isSpriteMaterial?c(p,d):d.isShadowMaterial?(p.color.value.copy(d.color),p.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(p,d){p.opacity.value=d.opacity,d.color&&p.diffuse.value.copy(d.color),d.emissive&&p.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.bumpMap&&(p.bumpMap.value=d.bumpMap,t(d.bumpMap,p.bumpMapTransform),p.bumpScale.value=d.bumpScale,d.side===Ot&&(p.bumpScale.value*=-1)),d.normalMap&&(p.normalMap.value=d.normalMap,t(d.normalMap,p.normalMapTransform),p.normalScale.value.copy(d.normalScale),d.side===Ot&&p.normalScale.value.negate()),d.displacementMap&&(p.displacementMap.value=d.displacementMap,t(d.displacementMap,p.displacementMapTransform),p.displacementScale.value=d.displacementScale,p.displacementBias.value=d.displacementBias),d.emissiveMap&&(p.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,p.emissiveMapTransform)),d.specularMap&&(p.specularMap.value=d.specularMap,t(d.specularMap,p.specularMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);const M=e.get(d),T=M.envMap,A=M.envMapRotation;T&&(p.envMap.value=T,p.envMapRotation.value.setFromMatrix4(Rg.makeRotationFromEuler(A)).transpose(),T.isCubeTexture&&T.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(Mc),p.reflectivity.value=d.reflectivity,p.ior.value=d.ior,p.refractionRatio.value=d.refractionRatio),d.lightMap&&(p.lightMap.value=d.lightMap,p.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,p.lightMapTransform)),d.aoMap&&(p.aoMap.value=d.aoMap,p.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,p.aoMapTransform))}function a(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform))}function o(p,d){p.dashSize.value=d.dashSize,p.totalSize.value=d.dashSize+d.gapSize,p.scale.value=d.scale}function l(p,d,M,T){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.size.value=d.size*M,p.scale.value=T*.5,d.map&&(p.map.value=d.map,t(d.map,p.uvTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function c(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.rotation.value=d.rotation,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function u(p,d){p.specular.value.copy(d.specular),p.shininess.value=Math.max(d.shininess,1e-4)}function f(p,d){d.gradientMap&&(p.gradientMap.value=d.gradientMap)}function h(p,d){p.metalness.value=d.metalness,d.metalnessMap&&(p.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,p.metalnessMapTransform)),p.roughness.value=d.roughness,d.roughnessMap&&(p.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,p.roughnessMapTransform)),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)}function m(p,d,M){p.ior.value=d.ior,d.sheen>0&&(p.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),p.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(p.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,p.sheenColorMapTransform)),d.sheenRoughnessMap&&(p.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,p.sheenRoughnessMapTransform))),d.clearcoat>0&&(p.clearcoat.value=d.clearcoat,p.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(p.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,p.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(p.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ot&&p.clearcoatNormalScale.value.negate())),d.dispersion>0&&(p.dispersion.value=d.dispersion),d.iridescence>0&&(p.iridescence.value=d.iridescence,p.iridescenceIOR.value=d.iridescenceIOR,p.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(p.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,p.iridescenceMapTransform)),d.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),d.transmission>0&&(p.transmission.value=d.transmission,p.transmissionSamplerMap.value=M.texture,p.transmissionSamplerSize.value.set(M.width,M.height),d.transmissionMap&&(p.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,p.transmissionMapTransform)),p.thickness.value=d.thickness,d.thicknessMap&&(p.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=d.attenuationDistance,p.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(p.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(p.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=d.specularIntensity,p.specularColor.value.copy(d.specularColor),d.specularColorMap&&(p.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,p.specularColorMapTransform)),d.specularIntensityMap&&(p.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,d){d.matcap&&(p.matcap.value=d.matcap)}function S(p,d){const M=e.get(d).light;p.referencePosition.value.setFromMatrixPosition(M.matrixWorld),p.nearDistance.value=M.shadow.camera.near,p.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Pg(i,e,t,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,T){const A=T.program;n.uniformBlockBinding(M,A)}function c(M,T){let A=s[M.id];A===void 0&&(g(M),A=u(M),s[M.id]=A,M.addEventListener("dispose",p));const P=T.program;n.updateUBOMapping(M,P);const b=e.render.frame;r[M.id]!==b&&(h(M),r[M.id]=b)}function u(M){const T=f();M.__bindingPointIndex=T;const A=i.createBuffer(),P=M.__size,b=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,A),i.bufferData(i.UNIFORM_BUFFER,P,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,A),A}function f(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return Ye("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(M){const T=s[M.id],A=M.uniforms,P=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let b=0,C=A.length;b<C;b++){const x=Array.isArray(A[b])?A[b]:[A[b]];for(let w=0,U=x.length;w<U;w++){const R=x[w];if(m(R,b,w,P)===!0){const B=R.__offset,X=Array.isArray(R.value)?R.value:[R.value];let Y=0;for(let N=0;N<X.length;N++){const H=X[N],G=S(H);typeof H=="number"||typeof H=="boolean"?(R.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,B+Y,R.__data)):H.isMatrix3?(R.__data[0]=H.elements[0],R.__data[1]=H.elements[1],R.__data[2]=H.elements[2],R.__data[3]=0,R.__data[4]=H.elements[3],R.__data[5]=H.elements[4],R.__data[6]=H.elements[5],R.__data[7]=0,R.__data[8]=H.elements[6],R.__data[9]=H.elements[7],R.__data[10]=H.elements[8],R.__data[11]=0):ArrayBuffer.isView(H)?R.__data.set(new H.constructor(H.buffer,H.byteOffset,R.__data.length)):(H.toArray(R.__data,Y),Y+=G.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,B,R.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(M,T,A,P){const b=M.value,C=T+"_"+A;if(P[C]===void 0)return typeof b=="number"||typeof b=="boolean"?P[C]=b:ArrayBuffer.isView(b)?P[C]=b.slice():P[C]=b.clone(),!0;{const x=P[C];if(typeof b=="number"||typeof b=="boolean"){if(x!==b)return P[C]=b,!0}else{if(ArrayBuffer.isView(b))return!0;if(x.equals(b)===!1)return x.copy(b),!0}}return!1}function g(M){const T=M.uniforms;let A=0;const P=16;for(let C=0,x=T.length;C<x;C++){const w=Array.isArray(T[C])?T[C]:[T[C]];for(let U=0,R=w.length;U<R;U++){const B=w[U],X=Array.isArray(B.value)?B.value:[B.value];for(let Y=0,N=X.length;Y<N;Y++){const H=X[Y],G=S(H),ee=A%P,te=ee%G.boundary,de=ee+te;A+=te,de!==0&&P-de<G.storage&&(A+=P-de),B.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=A,A+=G.storage}}}const b=A%P;return b>0&&(A+=P-b),M.__size=A,M.__cache={},this}function S(M){const T={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(T.boundary=4,T.storage=4):M.isVector2?(T.boundary=8,T.storage=8):M.isVector3||M.isColor?(T.boundary=16,T.storage=12):M.isVector4?(T.boundary=16,T.storage=16):M.isMatrix3?(T.boundary=48,T.storage=48):M.isMatrix4?(T.boundary=64,T.storage=64):M.isTexture?Le("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(T.boundary=16,T.storage=M.byteLength):Le("WebGLRenderer: Unsupported uniform value type.",M),T}function p(M){const T=M.target;T.removeEventListener("dispose",p);const A=a.indexOf(T.__bindingPointIndex);a.splice(A,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function d(){for(const M in s)i.deleteBuffer(s[M]);a=[],s={},r={}}return{bind:l,update:c,dispose:d}}const Lg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let an=null;function Dg(){return an===null&&(an=new fu(Lg,16,16,ri,Rn),an.name="DFG_LUT",an.minFilter=Rt,an.magFilter=Rt,an.wrapS=bn,an.wrapT=bn,an.generateMipmaps=!1,an.needsUpdate=!0),an}class Ig{constructor(e={}){const{canvas:t=Ah(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:m=Vt}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const S=m,p=new Set([Qa,Ja,$a]),d=new Set([Vt,mn,ts,ns,Ka,Za]),M=new Uint32Array(4),T=new Int32Array(4),A=new I;let P=null,b=null;const C=[],x=[];let w=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=un,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const U=this;let R=!1,B=null;this._outputColorSpace=Yt;let X=0,Y=0,N=null,H=-1,G=null;const ee=new mt,te=new mt;let de=null;const q=new He(0);let Q=0,ye=t.width,ke=t.height,Ee=1,Z=null,he=null;const se=new mt(0,0,ye,ke),Ae=new mt(0,0,ye,ke);let De=!1;const Pe=new ro;let st=!1,ze=!1;const Ze=new dt,je=new I,Ue=new mt,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ht=!1;function zt(){return N===null?Ee:1}let F=n;function St(v,O){return t.getContext(v,O)}try{const v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${qa}`),t.addEventListener("webglcontextlost",ne,!1),t.addEventListener("webglcontextrestored",Te,!1),t.addEventListener("webglcontextcreationerror",Fe,!1),F===null){const O="webgl2";if(F=St(O,v),F===null)throw St(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw Ye("WebGLRenderer: "+v.message),v}let Xe,ot,fe,ft,E,_,z,$,ie,re,ue,j,J,_e,Me,le,ae,Ie,Be,$e,D,oe,K;function xe(){Xe=new Dp(F),Xe.init(),D=new bg(F,Xe),ot=new Ep(F,Xe,e,D),fe=new Sg(F,Xe),ot.reversedDepthBuffer&&h&&fe.buffers.depth.setReversed(!0),ft=new Np(F),E=new og,_=new yg(F,Xe,fe,E,ot,D,ft),z=new Lp(U),$=new Bu(F),oe=new yp(F,$),ie=new Ip(F,$,ft,oe),re=new Op(F,ie,$,oe,ft),Ie=new Fp(F,ot,_),Me=new Tp(E),ue=new ag(U,z,Xe,ot,oe,Me),j=new Cg(U,E),J=new cg,_e=new mg(Xe),ae=new Sp(U,z,fe,re,g,l),le=new Mg(U,re,ot),K=new Pg(F,ft,ot,fe),Be=new bp(F,Xe,ft),$e=new Up(F,Xe,ft),ft.programs=ue.programs,U.capabilities=ot,U.extensions=Xe,U.properties=E,U.renderLists=J,U.shadowMap=le,U.state=fe,U.info=ft}xe(),S!==Vt&&(w=new zp(S,t.width,t.height,s,r));const ce=new wg(U,F);this.xr=ce,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const v=Xe.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Xe.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return Ee},this.setPixelRatio=function(v){v!==void 0&&(Ee=v,this.setSize(ye,ke,!1))},this.getSize=function(v){return v.set(ye,ke)},this.setSize=function(v,O,W=!0){if(ce.isPresenting){Le("WebGLRenderer: Can't change size while VR device is presenting.");return}ye=v,ke=O,t.width=Math.floor(v*Ee),t.height=Math.floor(O*Ee),W===!0&&(t.style.width=v+"px",t.style.height=O+"px"),w!==null&&w.setSize(t.width,t.height),this.setViewport(0,0,v,O)},this.getDrawingBufferSize=function(v){return v.set(ye*Ee,ke*Ee).floor()},this.setDrawingBufferSize=function(v,O,W){ye=v,ke=O,Ee=W,t.width=Math.floor(v*W),t.height=Math.floor(O*W),this.setViewport(0,0,v,O)},this.setEffects=function(v){if(S===Vt){Ye("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let O=0;O<v.length;O++)if(v[O].isOutputPass===!0){Le("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(ee)},this.getViewport=function(v){return v.copy(se)},this.setViewport=function(v,O,W,k){v.isVector4?se.set(v.x,v.y,v.z,v.w):se.set(v,O,W,k),fe.viewport(ee.copy(se).multiplyScalar(Ee).round())},this.getScissor=function(v){return v.copy(Ae)},this.setScissor=function(v,O,W,k){v.isVector4?Ae.set(v.x,v.y,v.z,v.w):Ae.set(v,O,W,k),fe.scissor(te.copy(Ae).multiplyScalar(Ee).round())},this.getScissorTest=function(){return De},this.setScissorTest=function(v){fe.setScissorTest(De=v)},this.setOpaqueSort=function(v){Z=v},this.setTransparentSort=function(v){he=v},this.getClearColor=function(v){return v.copy(ae.getClearColor())},this.setClearColor=function(){ae.setClearColor(...arguments)},this.getClearAlpha=function(){return ae.getClearAlpha()},this.setClearAlpha=function(){ae.setClearAlpha(...arguments)},this.clear=function(v=!0,O=!0,W=!0){let k=0;if(v){let V=!1;if(N!==null){const ge=N.texture.format;V=p.has(ge)}if(V){const ge=N.texture.type,Se=d.has(ge),me=ae.getClearColor(),be=ae.getClearAlpha(),we=me.r,Oe=me.g,Ve=me.b;Se?(M[0]=we,M[1]=Oe,M[2]=Ve,M[3]=be,F.clearBufferuiv(F.COLOR,0,M)):(T[0]=we,T[1]=Oe,T[2]=Ve,T[3]=be,F.clearBufferiv(F.COLOR,0,T))}else k|=F.COLOR_BUFFER_BIT}O&&(k|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(k|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k!==0&&F.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),B=v},this.dispose=function(){t.removeEventListener("webglcontextlost",ne,!1),t.removeEventListener("webglcontextrestored",Te,!1),t.removeEventListener("webglcontextcreationerror",Fe,!1),ae.dispose(),J.dispose(),_e.dispose(),E.dispose(),z.dispose(),re.dispose(),oe.dispose(),K.dispose(),ue.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",Mo),ce.removeEventListener("sessionend",So),jn.stop()};function ne(v){v.preventDefault(),Qs("WebGLRenderer: Context Lost."),R=!0}function Te(){Qs("WebGLRenderer: Context Restored."),R=!1;const v=ft.autoReset,O=le.enabled,W=le.autoUpdate,k=le.needsUpdate,V=le.type;xe(),ft.autoReset=v,le.enabled=O,le.autoUpdate=W,le.needsUpdate=k,le.type=V}function Fe(v){Ye("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function gt(v){const O=v.target;O.removeEventListener("dispose",gt),tt(O)}function tt(v){_n(v),E.remove(v)}function _n(v){const O=E.get(v).programs;O!==void 0&&(O.forEach(function(W){ue.releaseProgram(W)}),v.isShaderMaterial&&ue.releaseShaderCache(v))}this.renderBufferDirect=function(v,O,W,k,V,ge){O===null&&(O=Je);const Se=V.isMesh&&V.matrixWorld.determinant()<0,me=zc(v,O,W,k,V);fe.setMaterial(k,Se);let be=W.index,we=1;if(k.wireframe===!0){if(be=ie.getWireframeAttribute(W),be===void 0)return;we=2}const Oe=W.drawRange,Ve=W.attributes.position;let Re=Oe.start*we,nt=(Oe.start+Oe.count)*we;ge!==null&&(Re=Math.max(Re,ge.start*we),nt=Math.min(nt,(ge.start+ge.count)*we)),be!==null?(Re=Math.max(Re,0),nt=Math.min(nt,be.count)):Ve!=null&&(Re=Math.max(Re,0),nt=Math.min(nt,Ve.count));const _t=nt-Re;if(_t<0||_t===1/0)return;oe.setup(V,k,me,W,be);let pt,rt=Be;if(be!==null&&(pt=$.get(be),rt=$e,rt.setIndex(pt)),V.isMesh)k.wireframe===!0?(fe.setLineWidth(k.wireframeLinewidth*zt()),rt.setMode(F.LINES)):rt.setMode(F.TRIANGLES);else if(V.isLine){let Ct=k.linewidth;Ct===void 0&&(Ct=1),fe.setLineWidth(Ct*zt()),V.isLineSegments?rt.setMode(F.LINES):V.isLineLoop?rt.setMode(F.LINE_LOOP):rt.setMode(F.LINE_STRIP)}else V.isPoints?rt.setMode(F.POINTS):V.isSprite&&rt.setMode(F.TRIANGLES);if(V.isBatchedMesh)if(Xe.get("WEBGL_multi_draw"))rt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const Ct=V._multiDrawStarts,ve=V._multiDrawCounts,Gt=V._multiDrawCount,Ke=be?$.get(be).bytesPerElement:1,Xt=E.get(k).currentProgram.getUniforms();for(let sn=0;sn<Gt;sn++)Xt.setValue(F,"_gl_DrawID",sn),rt.render(Ct[sn]/Ke,ve[sn])}else if(V.isInstancedMesh)rt.renderInstances(Re,_t,V.count);else if(W.isInstancedBufferGeometry){const Ct=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,ve=Math.min(W.instanceCount,Ct);rt.renderInstances(Re,_t,ve)}else rt.render(Re,_t)};function nn(v,O,W){v.transparent===!0&&v.side===Qt&&v.forceSinglePass===!1?(v.side=Ot,v.needsUpdate=!0,ls(v,O,W),v.side=Wn,v.needsUpdate=!0,ls(v,O,W),v.side=Qt):ls(v,O,W)}this.compile=function(v,O,W=null){W===null&&(W=v),b=_e.get(W),b.init(O),x.push(b),W.traverseVisible(function(V){V.isLight&&V.layers.test(O.layers)&&(b.pushLight(V),V.castShadow&&b.pushShadow(V))}),v!==W&&v.traverseVisible(function(V){V.isLight&&V.layers.test(O.layers)&&(b.pushLight(V),V.castShadow&&b.pushShadow(V))}),b.setupLights();const k=new Set;return v.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const ge=V.material;if(ge)if(Array.isArray(ge))for(let Se=0;Se<ge.length;Se++){const me=ge[Se];nn(me,W,V),k.add(me)}else nn(ge,W,V),k.add(ge)}),b=x.pop(),k},this.compileAsync=function(v,O,W=null){const k=this.compile(v,O,W);return new Promise(V=>{function ge(){if(k.forEach(function(Se){E.get(Se).currentProgram.isReady()&&k.delete(Se)}),k.size===0){V(v);return}setTimeout(ge,10)}Xe.get("KHR_parallel_shader_compile")!==null?ge():setTimeout(ge,10)})};let cr=null;function Oc(v){cr&&cr(v)}function Mo(){jn.stop()}function So(){jn.start()}const jn=new fc;jn.setAnimationLoop(Oc),typeof self<"u"&&jn.setContext(self),this.setAnimationLoop=function(v){cr=v,ce.setAnimationLoop(v),v===null?jn.stop():jn.start()},ce.addEventListener("sessionstart",Mo),ce.addEventListener("sessionend",So),this.render=function(v,O){if(O!==void 0&&O.isCamera!==!0){Ye("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;B!==null&&B.renderStart(v,O);const W=ce.enabled===!0&&ce.isPresenting===!0,k=w!==null&&(N===null||W)&&w.begin(U,N);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(O),O=ce.getCamera()),v.isScene===!0&&v.onBeforeRender(U,v,O,N),b=_e.get(v,x.length),b.init(O),b.state.textureUnits=_.getTextureUnits(),x.push(b),Ze.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Pe.setFromProjectionMatrix(Ze,cn,O.reversedDepth),ze=this.localClippingEnabled,st=Me.init(this.clippingPlanes,ze),P=J.get(v,C.length),P.init(),C.push(P),ce.enabled===!0&&ce.isPresenting===!0){const Se=U.xr.getDepthSensingMesh();Se!==null&&hr(Se,O,-1/0,U.sortObjects)}hr(v,O,0,U.sortObjects),P.finish(),U.sortObjects===!0&&P.sort(Z,he),ht=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,ht&&ae.addToRenderList(P,v),this.info.render.frame++,st===!0&&Me.beginShadows();const V=b.state.shadowsArray;if(le.render(V,v,O),st===!0&&Me.endShadows(),this.info.autoReset===!0&&this.info.reset(),(k&&w.hasRenderPass())===!1){const Se=P.opaque,me=P.transmissive;if(b.setupLights(),O.isArrayCamera){const be=O.cameras;if(me.length>0)for(let we=0,Oe=be.length;we<Oe;we++){const Ve=be[we];bo(Se,me,v,Ve)}ht&&ae.render(v);for(let we=0,Oe=be.length;we<Oe;we++){const Ve=be[we];yo(P,v,Ve,Ve.viewport)}}else me.length>0&&bo(Se,me,v,O),ht&&ae.render(v),yo(P,v,O)}N!==null&&Y===0&&(_.updateMultisampleRenderTarget(N),_.updateRenderTargetMipmap(N)),k&&w.end(U),v.isScene===!0&&v.onAfterRender(U,v,O),oe.resetDefaultState(),H=-1,G=null,x.pop(),x.length>0?(b=x[x.length-1],_.setTextureUnits(b.state.textureUnits),st===!0&&Me.setGlobalState(U.clippingPlanes,b.state.camera)):b=null,C.pop(),C.length>0?P=C[C.length-1]:P=null,B!==null&&B.renderEnd()};function hr(v,O,W,k){if(v.visible===!1)return;if(v.layers.test(O.layers)){if(v.isGroup)W=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(O);else if(v.isLightProbeGrid)b.pushLightProbeGrid(v);else if(v.isLight)b.pushLight(v),v.castShadow&&b.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Pe.intersectsSprite(v)){k&&Ue.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Ze);const Se=re.update(v),me=v.material;me.visible&&P.push(v,Se,me,W,Ue.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Pe.intersectsObject(v))){const Se=re.update(v),me=v.material;if(k&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Ue.copy(v.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Ue.copy(Se.boundingSphere.center)),Ue.applyMatrix4(v.matrixWorld).applyMatrix4(Ze)),Array.isArray(me)){const be=Se.groups;for(let we=0,Oe=be.length;we<Oe;we++){const Ve=be[we],Re=me[Ve.materialIndex];Re&&Re.visible&&P.push(v,Se,Re,W,Ue.z,Ve)}}else me.visible&&P.push(v,Se,me,W,Ue.z,null)}}const ge=v.children;for(let Se=0,me=ge.length;Se<me;Se++)hr(ge[Se],O,W,k)}function yo(v,O,W,k){const{opaque:V,transmissive:ge,transparent:Se}=v;b.setupLightsView(W),st===!0&&Me.setGlobalState(U.clippingPlanes,W),k&&fe.viewport(ee.copy(k)),V.length>0&&os(V,O,W),ge.length>0&&os(ge,O,W),Se.length>0&&os(Se,O,W),fe.buffers.depth.setTest(!0),fe.buffers.depth.setMask(!0),fe.buffers.color.setMask(!0),fe.setPolygonOffset(!1)}function bo(v,O,W,k){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[k.id]===void 0){const Re=Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[k.id]=new dn(1,1,{generateMipmaps:!0,type:Re?Rn:Vt,minFilter:ti,samples:Math.max(4,ot.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:qe.workingColorSpace})}const ge=b.state.transmissionRenderTarget[k.id],Se=k.viewport||ee;ge.setSize(Se.z*U.transmissionResolutionScale,Se.w*U.transmissionResolutionScale);const me=U.getRenderTarget(),be=U.getActiveCubeFace(),we=U.getActiveMipmapLevel();U.setRenderTarget(ge),U.getClearColor(q),Q=U.getClearAlpha(),Q<1&&U.setClearColor(16777215,.5),U.clear(),ht&&ae.render(W);const Oe=U.toneMapping;U.toneMapping=un;const Ve=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),b.setupLightsView(k),st===!0&&Me.setGlobalState(U.clippingPlanes,k),os(v,W,k),_.updateMultisampleRenderTarget(ge),_.updateRenderTargetMipmap(ge),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let Re=!1;for(let nt=0,_t=O.length;nt<_t;nt++){const pt=O[nt],{object:rt,geometry:Ct,material:ve,group:Gt}=pt;if(ve.side===Qt&&rt.layers.test(k.layers)){const Ke=ve.side;ve.side=Ot,ve.needsUpdate=!0,Eo(rt,W,k,Ct,ve,Gt),ve.side=Ke,ve.needsUpdate=!0,Re=!0}}Re===!0&&(_.updateMultisampleRenderTarget(ge),_.updateRenderTargetMipmap(ge))}U.setRenderTarget(me,be,we),U.setClearColor(q,Q),Ve!==void 0&&(k.viewport=Ve),U.toneMapping=Oe}function os(v,O,W){const k=O.isScene===!0?O.overrideMaterial:null;for(let V=0,ge=v.length;V<ge;V++){const Se=v[V],{object:me,geometry:be,group:we}=Se;let Oe=Se.material;Oe.allowOverride===!0&&k!==null&&(Oe=k),me.layers.test(W.layers)&&Eo(me,O,W,be,Oe,we)}}function Eo(v,O,W,k,V,ge){v.onBeforeRender(U,O,W,k,V,ge),v.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),V.onBeforeRender(U,O,W,k,v,ge),V.transparent===!0&&V.side===Qt&&V.forceSinglePass===!1?(V.side=Ot,V.needsUpdate=!0,U.renderBufferDirect(W,O,k,V,v,ge),V.side=Wn,V.needsUpdate=!0,U.renderBufferDirect(W,O,k,V,v,ge),V.side=Qt):U.renderBufferDirect(W,O,k,V,v,ge),v.onAfterRender(U,O,W,k,V,ge)}function ls(v,O,W){O.isScene!==!0&&(O=Je);const k=E.get(v),V=b.state.lights,ge=b.state.shadowsArray,Se=V.state.version,me=ue.getParameters(v,V.state,ge,O,W,b.state.lightProbeGridArray),be=ue.getProgramCacheKey(me);let we=k.programs;k.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?O.environment:null,k.fog=O.fog;const Oe=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;k.envMap=z.get(v.envMap||k.environment,Oe),k.envMapRotation=k.environment!==null&&v.envMap===null?O.environmentRotation:v.envMapRotation,we===void 0&&(v.addEventListener("dispose",gt),we=new Map,k.programs=we);let Ve=we.get(be);if(Ve!==void 0){if(k.currentProgram===Ve&&k.lightsStateVersion===Se)return Ao(v,me),Ve}else me.uniforms=ue.getUniforms(v),B!==null&&v.isNodeMaterial&&B.build(v,W,me),v.onBeforeCompile(me,U),Ve=ue.acquireProgram(me,be),we.set(be,Ve),k.uniforms=me.uniforms;const Re=k.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Re.clippingPlanes=Me.uniform),Ao(v,me),k.needsLights=Hc(v),k.lightsStateVersion=Se,k.needsLights&&(Re.ambientLightColor.value=V.state.ambient,Re.lightProbe.value=V.state.probe,Re.directionalLights.value=V.state.directional,Re.directionalLightShadows.value=V.state.directionalShadow,Re.spotLights.value=V.state.spot,Re.spotLightShadows.value=V.state.spotShadow,Re.rectAreaLights.value=V.state.rectArea,Re.ltc_1.value=V.state.rectAreaLTC1,Re.ltc_2.value=V.state.rectAreaLTC2,Re.pointLights.value=V.state.point,Re.pointLightShadows.value=V.state.pointShadow,Re.hemisphereLights.value=V.state.hemi,Re.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Re.spotLightMatrix.value=V.state.spotLightMatrix,Re.spotLightMap.value=V.state.spotLightMap,Re.pointShadowMatrix.value=V.state.pointShadowMatrix),k.lightProbeGrid=b.state.lightProbeGridArray.length>0,k.currentProgram=Ve,k.uniformsList=null,Ve}function To(v){if(v.uniformsList===null){const O=v.currentProgram.getUniforms();v.uniformsList=qs.seqWithValue(O.seq,v.uniforms)}return v.uniformsList}function Ao(v,O){const W=E.get(v);W.outputColorSpace=O.outputColorSpace,W.batching=O.batching,W.batchingColor=O.batchingColor,W.instancing=O.instancing,W.instancingColor=O.instancingColor,W.instancingMorph=O.instancingMorph,W.skinning=O.skinning,W.morphTargets=O.morphTargets,W.morphNormals=O.morphNormals,W.morphColors=O.morphColors,W.morphTargetsCount=O.morphTargetsCount,W.numClippingPlanes=O.numClippingPlanes,W.numIntersection=O.numClipIntersection,W.vertexAlphas=O.vertexAlphas,W.vertexTangents=O.vertexTangents,W.toneMapping=O.toneMapping}function Bc(v,O){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;A.setFromMatrixPosition(O.matrixWorld);for(let W=0,k=v.length;W<k;W++){const V=v[W];if(V.texture!==null&&V.boundingBox.containsPoint(A))return V}return null}function zc(v,O,W,k,V){O.isScene!==!0&&(O=Je),_.resetTextureUnits();const ge=O.fog,Se=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?O.environment:null,me=N===null?U.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:qe.workingColorSpace,be=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,we=z.get(k.envMap||Se,be),Oe=k.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Ve=!!W.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Re=!!W.morphAttributes.position,nt=!!W.morphAttributes.normal,_t=!!W.morphAttributes.color;let pt=un;k.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(pt=U.toneMapping);const rt=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Ct=rt!==void 0?rt.length:0,ve=E.get(k),Gt=b.state.lights;if(st===!0&&(ze===!0||v!==G)){const lt=v===G&&k.id===H;Me.setState(k,v,lt)}let Ke=!1;k.version===ve.__version?(ve.needsLights&&ve.lightsStateVersion!==Gt.state.version||ve.outputColorSpace!==me||V.isBatchedMesh&&ve.batching===!1||!V.isBatchedMesh&&ve.batching===!0||V.isBatchedMesh&&ve.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&ve.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&ve.instancing===!1||!V.isInstancedMesh&&ve.instancing===!0||V.isSkinnedMesh&&ve.skinning===!1||!V.isSkinnedMesh&&ve.skinning===!0||V.isInstancedMesh&&ve.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&ve.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&ve.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&ve.instancingMorph===!1&&V.morphTexture!==null||ve.envMap!==we||k.fog===!0&&ve.fog!==ge||ve.numClippingPlanes!==void 0&&(ve.numClippingPlanes!==Me.numPlanes||ve.numIntersection!==Me.numIntersection)||ve.vertexAlphas!==Oe||ve.vertexTangents!==Ve||ve.morphTargets!==Re||ve.morphNormals!==nt||ve.morphColors!==_t||ve.toneMapping!==pt||ve.morphTargetsCount!==Ct||!!ve.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(Ke=!0):(Ke=!0,ve.__version=k.version);let Xt=ve.currentProgram;Ke===!0&&(Xt=ls(k,O,V),B&&k.isNodeMaterial&&B.onUpdateProgram(k,Xt,ve));let sn=!1,Pn=!1,oi=!1;const at=Xt.getUniforms(),xt=ve.uniforms;if(fe.useProgram(Xt.program)&&(sn=!0,Pn=!0,oi=!0),k.id!==H&&(H=k.id,Pn=!0),ve.needsLights){const lt=Bc(b.state.lightProbeGridArray,V);ve.lightProbeGrid!==lt&&(ve.lightProbeGrid=lt,Pn=!0)}if(sn||G!==v){fe.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),at.setValue(F,"projectionMatrix",v.projectionMatrix),at.setValue(F,"viewMatrix",v.matrixWorldInverse);const Dn=at.map.cameraPosition;Dn!==void 0&&Dn.setValue(F,je.setFromMatrixPosition(v.matrixWorld)),ot.logarithmicDepthBuffer&&at.setValue(F,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&at.setValue(F,"isOrthographic",v.isOrthographicCamera===!0),G!==v&&(G=v,Pn=!0,oi=!0)}if(ve.needsLights&&(Gt.state.directionalShadowMap.length>0&&at.setValue(F,"directionalShadowMap",Gt.state.directionalShadowMap,_),Gt.state.spotShadowMap.length>0&&at.setValue(F,"spotShadowMap",Gt.state.spotShadowMap,_),Gt.state.pointShadowMap.length>0&&at.setValue(F,"pointShadowMap",Gt.state.pointShadowMap,_)),V.isSkinnedMesh){at.setOptional(F,V,"bindMatrix"),at.setOptional(F,V,"bindMatrixInverse");const lt=V.skeleton;lt&&(lt.boneTexture===null&&lt.computeBoneTexture(),at.setValue(F,"boneTexture",lt.boneTexture,_))}V.isBatchedMesh&&(at.setOptional(F,V,"batchingTexture"),at.setValue(F,"batchingTexture",V._matricesTexture,_),at.setOptional(F,V,"batchingIdTexture"),at.setValue(F,"batchingIdTexture",V._indirectTexture,_),at.setOptional(F,V,"batchingColorTexture"),V._colorsTexture!==null&&at.setValue(F,"batchingColorTexture",V._colorsTexture,_));const Ln=W.morphAttributes;if((Ln.position!==void 0||Ln.normal!==void 0||Ln.color!==void 0)&&Ie.update(V,W,Xt),(Pn||ve.receiveShadow!==V.receiveShadow)&&(ve.receiveShadow=V.receiveShadow,at.setValue(F,"receiveShadow",V.receiveShadow)),(k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial)&&k.envMap===null&&O.environment!==null&&(xt.envMapIntensity.value=O.environmentIntensity),xt.dfgLUT!==void 0&&(xt.dfgLUT.value=Dg()),Pn){if(at.setValue(F,"toneMappingExposure",U.toneMappingExposure),ve.needsLights&&Gc(xt,oi),ge&&k.fog===!0&&j.refreshFogUniforms(xt,ge),j.refreshMaterialUniforms(xt,k,Ee,ke,b.state.transmissionRenderTarget[v.id]),ve.needsLights&&ve.lightProbeGrid){const lt=ve.lightProbeGrid;xt.probesSH.value=lt.texture,xt.probesMin.value.copy(lt.boundingBox.min),xt.probesMax.value.copy(lt.boundingBox.max),xt.probesResolution.value.copy(lt.resolution)}qs.upload(F,To(ve),xt,_)}if(k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(qs.upload(F,To(ve),xt,_),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&at.setValue(F,"center",V.center),at.setValue(F,"modelViewMatrix",V.modelViewMatrix),at.setValue(F,"normalMatrix",V.normalMatrix),at.setValue(F,"modelMatrix",V.matrixWorld),k.uniformsGroups!==void 0){const lt=k.uniformsGroups;for(let Dn=0,li=lt.length;Dn<li;Dn++){const wo=lt[Dn];K.update(wo,Xt),K.bind(wo,Xt)}}return Xt}function Gc(v,O){v.ambientLightColor.needsUpdate=O,v.lightProbe.needsUpdate=O,v.directionalLights.needsUpdate=O,v.directionalLightShadows.needsUpdate=O,v.pointLights.needsUpdate=O,v.pointLightShadows.needsUpdate=O,v.spotLights.needsUpdate=O,v.spotLightShadows.needsUpdate=O,v.rectAreaLights.needsUpdate=O,v.hemisphereLights.needsUpdate=O}function Hc(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return Y},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(v,O,W){const k=E.get(v);k.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),E.get(v.texture).__webglTexture=O,E.get(v.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:W,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,O){const W=E.get(v);W.__webglFramebuffer=O,W.__useDefaultFramebuffer=O===void 0};const kc=F.createFramebuffer();this.setRenderTarget=function(v,O=0,W=0){N=v,X=O,Y=W;let k=null,V=!1,ge=!1;if(v){const me=E.get(v);if(me.__useDefaultFramebuffer!==void 0){fe.bindFramebuffer(F.FRAMEBUFFER,me.__webglFramebuffer),ee.copy(v.viewport),te.copy(v.scissor),de=v.scissorTest,fe.viewport(ee),fe.scissor(te),fe.setScissorTest(de),H=-1;return}else if(me.__webglFramebuffer===void 0)_.setupRenderTarget(v);else if(me.__hasExternalTextures)_.rebindTextures(v,E.get(v.texture).__webglTexture,E.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Oe=v.depthTexture;if(me.__boundDepthTexture!==Oe){if(Oe!==null&&E.has(Oe)&&(v.width!==Oe.image.width||v.height!==Oe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");_.setupDepthRenderbuffer(v)}}const be=v.texture;(be.isData3DTexture||be.isDataArrayTexture||be.isCompressedArrayTexture)&&(ge=!0);const we=E.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(we[O])?k=we[O][W]:k=we[O],V=!0):v.samples>0&&_.useMultisampledRTT(v)===!1?k=E.get(v).__webglMultisampledFramebuffer:Array.isArray(we)?k=we[W]:k=we,ee.copy(v.viewport),te.copy(v.scissor),de=v.scissorTest}else ee.copy(se).multiplyScalar(Ee).floor(),te.copy(Ae).multiplyScalar(Ee).floor(),de=De;if(W!==0&&(k=kc),fe.bindFramebuffer(F.FRAMEBUFFER,k)&&fe.drawBuffers(v,k),fe.viewport(ee),fe.scissor(te),fe.setScissorTest(de),V){const me=E.get(v.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+O,me.__webglTexture,W)}else if(ge){const me=O;for(let be=0;be<v.textures.length;be++){const we=E.get(v.textures[be]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+be,we.__webglTexture,W,me)}}else if(v!==null&&W!==0){const me=E.get(v.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,me.__webglTexture,W)}H=-1},this.readRenderTargetPixels=function(v,O,W,k,V,ge,Se,me=0){if(!(v&&v.isWebGLRenderTarget)){Ye("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let be=E.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&Se!==void 0&&(be=be[Se]),be){fe.bindFramebuffer(F.FRAMEBUFFER,be);try{const we=v.textures[me],Oe=we.format,Ve=we.type;if(v.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+me),!ot.textureFormatReadable(Oe)){Ye("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ot.textureTypeReadable(Ve)){Ye("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=v.width-k&&W>=0&&W<=v.height-V&&F.readPixels(O,W,k,V,D.convert(Oe),D.convert(Ve),ge)}finally{const we=N!==null?E.get(N).__webglFramebuffer:null;fe.bindFramebuffer(F.FRAMEBUFFER,we)}}},this.readRenderTargetPixelsAsync=async function(v,O,W,k,V,ge,Se,me=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let be=E.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&Se!==void 0&&(be=be[Se]),be)if(O>=0&&O<=v.width-k&&W>=0&&W<=v.height-V){fe.bindFramebuffer(F.FRAMEBUFFER,be);const we=v.textures[me],Oe=we.format,Ve=we.type;if(v.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+me),!ot.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ot.textureTypeReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Re=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,Re),F.bufferData(F.PIXEL_PACK_BUFFER,ge.byteLength,F.STREAM_READ),F.readPixels(O,W,k,V,D.convert(Oe),D.convert(Ve),0);const nt=N!==null?E.get(N).__webglFramebuffer:null;fe.bindFramebuffer(F.FRAMEBUFFER,nt);const _t=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await wh(F,_t,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,Re),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,ge),F.deleteBuffer(Re),F.deleteSync(_t),ge}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,O=null,W=0){const k=Math.pow(2,-W),V=Math.floor(v.image.width*k),ge=Math.floor(v.image.height*k),Se=O!==null?O.x:0,me=O!==null?O.y:0;_.setTexture2D(v,0),F.copyTexSubImage2D(F.TEXTURE_2D,W,0,0,Se,me,V,ge),fe.unbindTexture()};const Vc=F.createFramebuffer(),Wc=F.createFramebuffer();this.copyTextureToTexture=function(v,O,W=null,k=null,V=0,ge=0){let Se,me,be,we,Oe,Ve,Re,nt,_t;const pt=v.isCompressedTexture?v.mipmaps[ge]:v.image;if(W!==null)Se=W.max.x-W.min.x,me=W.max.y-W.min.y,be=W.isBox3?W.max.z-W.min.z:1,we=W.min.x,Oe=W.min.y,Ve=W.isBox3?W.min.z:0;else{const xt=Math.pow(2,-V);Se=Math.floor(pt.width*xt),me=Math.floor(pt.height*xt),v.isDataArrayTexture?be=pt.depth:v.isData3DTexture?be=Math.floor(pt.depth*xt):be=1,we=0,Oe=0,Ve=0}k!==null?(Re=k.x,nt=k.y,_t=k.z):(Re=0,nt=0,_t=0);const rt=D.convert(O.format),Ct=D.convert(O.type);let ve;O.isData3DTexture?(_.setTexture3D(O,0),ve=F.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(_.setTexture2DArray(O,0),ve=F.TEXTURE_2D_ARRAY):(_.setTexture2D(O,0),ve=F.TEXTURE_2D),fe.activeTexture(F.TEXTURE0),fe.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,O.flipY),fe.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),fe.pixelStorei(F.UNPACK_ALIGNMENT,O.unpackAlignment);const Gt=fe.getParameter(F.UNPACK_ROW_LENGTH),Ke=fe.getParameter(F.UNPACK_IMAGE_HEIGHT),Xt=fe.getParameter(F.UNPACK_SKIP_PIXELS),sn=fe.getParameter(F.UNPACK_SKIP_ROWS),Pn=fe.getParameter(F.UNPACK_SKIP_IMAGES);fe.pixelStorei(F.UNPACK_ROW_LENGTH,pt.width),fe.pixelStorei(F.UNPACK_IMAGE_HEIGHT,pt.height),fe.pixelStorei(F.UNPACK_SKIP_PIXELS,we),fe.pixelStorei(F.UNPACK_SKIP_ROWS,Oe),fe.pixelStorei(F.UNPACK_SKIP_IMAGES,Ve);const oi=v.isDataArrayTexture||v.isData3DTexture,at=O.isDataArrayTexture||O.isData3DTexture;if(v.isDepthTexture){const xt=E.get(v),Ln=E.get(O),lt=E.get(xt.__renderTarget),Dn=E.get(Ln.__renderTarget);fe.bindFramebuffer(F.READ_FRAMEBUFFER,lt.__webglFramebuffer),fe.bindFramebuffer(F.DRAW_FRAMEBUFFER,Dn.__webglFramebuffer);for(let li=0;li<be;li++)oi&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,E.get(v).__webglTexture,V,Ve+li),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,E.get(O).__webglTexture,ge,_t+li)),F.blitFramebuffer(we,Oe,Se,me,Re,nt,Se,me,F.DEPTH_BUFFER_BIT,F.NEAREST);fe.bindFramebuffer(F.READ_FRAMEBUFFER,null),fe.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(V!==0||v.isRenderTargetTexture||E.has(v)){const xt=E.get(v),Ln=E.get(O);fe.bindFramebuffer(F.READ_FRAMEBUFFER,Vc),fe.bindFramebuffer(F.DRAW_FRAMEBUFFER,Wc);for(let lt=0;lt<be;lt++)oi?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,xt.__webglTexture,V,Ve+lt):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,xt.__webglTexture,V),at?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ln.__webglTexture,ge,_t+lt):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Ln.__webglTexture,ge),V!==0?F.blitFramebuffer(we,Oe,Se,me,Re,nt,Se,me,F.COLOR_BUFFER_BIT,F.NEAREST):at?F.copyTexSubImage3D(ve,ge,Re,nt,_t+lt,we,Oe,Se,me):F.copyTexSubImage2D(ve,ge,Re,nt,we,Oe,Se,me);fe.bindFramebuffer(F.READ_FRAMEBUFFER,null),fe.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else at?v.isDataTexture||v.isData3DTexture?F.texSubImage3D(ve,ge,Re,nt,_t,Se,me,be,rt,Ct,pt.data):O.isCompressedArrayTexture?F.compressedTexSubImage3D(ve,ge,Re,nt,_t,Se,me,be,rt,pt.data):F.texSubImage3D(ve,ge,Re,nt,_t,Se,me,be,rt,Ct,pt):v.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,ge,Re,nt,Se,me,rt,Ct,pt.data):v.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,ge,Re,nt,pt.width,pt.height,rt,pt.data):F.texSubImage2D(F.TEXTURE_2D,ge,Re,nt,Se,me,rt,Ct,pt);fe.pixelStorei(F.UNPACK_ROW_LENGTH,Gt),fe.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ke),fe.pixelStorei(F.UNPACK_SKIP_PIXELS,Xt),fe.pixelStorei(F.UNPACK_SKIP_ROWS,sn),fe.pixelStorei(F.UNPACK_SKIP_IMAGES,Pn),ge===0&&O.generateMipmaps&&F.generateMipmap(ve),fe.unbindTexture()},this.initRenderTarget=function(v){E.get(v).__webglFramebuffer===void 0&&_.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?_.setTextureCube(v,0):v.isData3DTexture?_.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?_.setTexture2DArray(v,0):_.setTexture2D(v,0),fe.unbindTexture()},this.resetState=function(){X=0,Y=0,N=null,fe.reset(),oe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return cn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=qe._getDrawingBufferColorSpace(e),t.unpackColorSpace=qe._getUnpackColorSpace()}}const Ul={type:"change"},uo={type:"start"},Sc={type:"end"},zs=new so,Nl=new zn,Ug=Math.cos(70*Xh.DEG2RAD),yt=new I,Ft=2*Math.PI,it={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},qr=1e-6;class Ng extends Fu{constructor(e,t=null){super(e,t),this.state=it.NONE,this.target=new I,this.cursor=new I,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:En.ROTATE,MIDDLE:En.DOLLY,RIGHT:En.PAN},this.touches={ONE:Hn.ROTATE,TWO:Hn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new I,this._lastQuaternion=new Xn,this._lastTargetPosition=new I,this._quat=new Xn().setFromUnitVectors(e.up,new I(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ll,this._sphericalDelta=new ll,this._scale=1,this._panOffset=new I,this._rotateStart=new Ce,this._rotateEnd=new Ce,this._rotateDelta=new Ce,this._panStart=new Ce,this._panEnd=new Ce,this._panDelta=new Ce,this._dollyStart=new Ce,this._dollyEnd=new Ce,this._dollyDelta=new Ce,this._dollyDirection=new I,this._mouse=new Ce,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Og.bind(this),this._onPointerDown=Fg.bind(this),this._onPointerUp=Bg.bind(this),this._onContextMenu=Xg.bind(this),this._onMouseWheel=Hg.bind(this),this._onKeyDown=kg.bind(this),this._onTouchStart=Vg.bind(this),this._onTouchMove=Wg.bind(this),this._onMouseDown=zg.bind(this),this._onMouseMove=Gg.bind(this),this._interceptControlDown=qg.bind(this),this._interceptControlUp=Yg.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=""}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Ul),this.update(),this.state=it.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){const t=this.object.position;yt.copy(t).sub(this.target),yt.applyQuaternion(this._quat),this._spherical.setFromVector3(yt),this.autoRotate&&this.state===it.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=Ft:n>Math.PI&&(n-=Ft),s<-Math.PI?s+=Ft:s>Math.PI&&(s-=Ft),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(yt.setFromSpherical(this._spherical),yt.applyQuaternion(this._quatInverse),t.copy(this.target).add(yt),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=yt.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){const o=new I(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;const c=new I(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=yt.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(zs.origin.copy(this.object.position),zs.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(zs.direction))<Ug?this.object.lookAt(this.target):(Nl.setFromNormalAndCoplanarPoint(this.object.up,this.target),zs.intersectPlane(Nl,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>qr||8*(1-this._lastQuaternion.dot(this.object.quaternion))>qr||this._lastTargetPosition.distanceToSquared(this.target)>qr?(this.dispatchEvent(Ul),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?Ft/60*this.autoRotateSpeed*e:Ft/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){yt.setFromMatrixColumn(t,0),yt.multiplyScalar(-e),this._panOffset.add(yt)}_panUp(e,t){this.screenSpacePanning===!0?yt.setFromMatrixColumn(t,1):(yt.setFromMatrixColumn(t,0),yt.crossVectors(this.object.up,yt)),yt.multiplyScalar(e),this._panOffset.add(yt)}_pan(e,t){const n=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;yt.copy(s).sub(this.target);let r=yt.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*r/n.clientHeight,this.object.matrix),this._panUp(2*t*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),s=e-n.left,r=t-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Ft*this._rotateDelta.x/t.clientHeight),this._rotateUp(Ft*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Ft*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Ft*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Ft*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Ft*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panStart.set(n,s)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,s=e.pageY-t.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),s=.5*(e.pageX+n.x),r=.5*(e.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Ft*this._rotateDelta.x/t.clientHeight),this._rotateUp(Ft*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,s=e.pageY-t.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Ce,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function Fg(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function Og(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function Bg(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Sc),this.state=it.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function zg(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case En.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=it.DOLLY;break;case En.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=it.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=it.ROTATE}break;case En.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=it.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=it.PAN}break;default:this.state=it.NONE}this.state!==it.NONE&&this.dispatchEvent(uo)}function Gg(i){switch(this.state){case it.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case it.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case it.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function Hg(i){this.enabled===!1||this.enableZoom===!1||this.state!==it.NONE||(i.preventDefault(),this.dispatchEvent(uo),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(Sc))}function kg(i){this.enabled!==!1&&this._handleKeyDown(i)}function Vg(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case Hn.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=it.TOUCH_ROTATE;break;case Hn.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=it.TOUCH_PAN;break;default:this.state=it.NONE}break;case 2:switch(this.touches.TWO){case Hn.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=it.TOUCH_DOLLY_PAN;break;case Hn.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=it.TOUCH_DOLLY_ROTATE;break;default:this.state=it.NONE}break;default:this.state=it.NONE}this.state!==it.NONE&&this.dispatchEvent(uo)}function Wg(i){switch(this._trackPointer(i),this.state){case it.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case it.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case it.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case it.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=it.NONE}}function Xg(i){this.enabled!==!1&&i.preventDefault()}function qg(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Yg(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function jg(){const i=L("viewport"),e=i.clientWidth,t=i.clientHeight,n=new ru,s=document.createElement("canvas");s.width=2,s.height=256;const r=s.getContext("2d"),a=r.createLinearGradient(0,0,0,256);a.addColorStop(0,"#0a0c12"),a.addColorStop(.5,"#0c0e14"),a.addColorStop(1,"#11131c"),r.fillStyle=a,r.fillRect(0,0,2,256);const o=new lc(s);o.magFilter=Rt,n.background=o;const l=new jt(45,e/t,1,1e4);l.position.set(300,200,400);const c=new Ig({antialias:!0});c.setSize(e,t),c.setPixelRatio(Math.min(devicePixelRatio,2)),c.toneMapping=Ya,c.toneMappingExposure=1,i.appendChild(c.domElement);const u=new Ng(l,c.domElement);u.enableDamping=!0,u.dampingFactor=.08,u.target.set(0,0,0),u.mouseButtons={LEFT:En.ROTATE,MIDDLE:En.DOLLY,RIGHT:En.PAN},u.touches={ONE:Hn.ROTATE_PAN,TWO:Hn.DOLLY_PAN},n.add(new Lu(4210784,1)),n.add(new Ru(6326476,3153984,.4));const f=new ol(16777215,.9);f.position.set(200,300,400),n.add(f);const h=new ol(6719692,.35);h.position.set(-200,-100,-300),n.add(h);const m=new Uu(800,20,2764094,1974576);m.material.transparent=!0,m.material.opacity=.6,n.add(m),n.add(new Nu(150)),y.scene=n,y.camera=l,y.renderer=c,y.controls=u,Rc(),y.labelsGroup&&(y.labelsGroup.visible=!1);let g=!1;y.renderScene=function(){g||(g=!0,requestAnimationFrame(function(){g=!1,y.renderer&&y.renderer.render(y.scene,y.camera)}))},u.addEventListener("change",y.renderScene),y.renderScene();let S=!1;const p=new ResizeObserver(function(){S||(S=!0,requestAnimationFrame(function(){S=!1,yc()}))});p.observe(i),y._resizeObserver=p}function yc(){var n;if(!y.renderer)return;const i=L("viewport"),e=i.clientWidth,t=i.clientHeight;e===0||t===0||(y.camera.aspect=e/t,y.camera.updateProjectionMatrix(),y.renderer.setSize(e,t),(n=y.renderScene)==null||n.call(y))}function bc(){var i;!y.camera||(y.camera.position.set(300,200,400),y.controls.target.set(0,0,0),y.controls.update(),(i=y.renderScene)==null||i.call(y))}let wi=null;function fo(i,e,t,n=400){if(!i)return;wi&&(cancelAnimationFrame(wi),wi=null);const s=i.rotation.x,r=i.rotation.y,a=e-s;let o=t-r;o>Math.PI?o-=Math.PI*2:o<-Math.PI&&(o+=Math.PI*2);const l=performance.now();function c(u){const f=u-l,h=Math.min(f/n,1),m=1-Math.pow(1-h,3);i.rotation.x=s+a*m,i.rotation.y=r+o*m,h<1?wi=requestAnimationFrame(c):(i.rotation.x=e,i.rotation.y=t,wi=null)}wi=requestAnimationFrame(c)}function Ec(i){var f;if(y.meshObject&&(y.scene.remove(y.meshObject),y.meshObject.geometry.dispose(),y.meshObject.material.dispose(),y.meshObject=null),!(i!=null&&i.length))return;const e=new Float32Array(i),t=new Mt;t.setAttribute("position",new Bt(e,3));const n=e.length/9,s=new Uint32Array(n*3);for(let h=0;h<n;h++)s[h*3]=h*3,s[h*3+1]=h*3+1,s[h*3+2]=h*3+2;t.setIndex(new Bt(s,1)),t.computeVertexNormals(),t.computeBoundingBox();const r=new I;t.boundingBox.getCenter(r),t.translate(-r.x,-r.y,-r.z);const a=new Eu({color:3900150,metalness:.35,roughness:.55,clearcoat:.15,clearcoatRoughness:.4,envMapIntensity:.6,side:Qt}),o=new ut(t,a);y.scene.add(o),y.meshObject=o;const c=new Gi().setFromObject(o).getSize(new I),u=Math.max(c.x,c.y,c.z)*1.8;y.camera.position.set(u*.6,u*.4,u*.8),y.controls.target.set(0,0,0),y.controls.update(),(f=y.renderScene)==null||f.call(y)}function Tc(){var e;if(!y.meshObject||!y.meshObject.geometry)return;const i=y.meshObject.geometry;if(y.facePenetrations){if(!i.attributes.color){const r=i.attributes.position,a=i.index,o=a?a.count/3:r.count/3,l=new Float32Array(r.count*3),c=y.facePenMax-y.facePenMin||1;for(let u=0;u<o&&u<y.facePenetrations.length;u++){const f=(y.facePenetrations[u]-y.facePenMin)/c;let h,m,g;if(f<=.5){const T=f/.5;h=30+T*200,m=180-T*130,g=40-T*30}else{const T=(f-.5)/.5;h=230+T*25,m=50-T*40,g=10-T*8}const S=u*3,p=a?a.getX(S):S,d=a?a.getX(S+1):S+1,M=a?a.getX(S+2):S+2;[p,d,M].forEach(T=>{l[T*3]=h/255,l[T*3+1]=m/255,l[T*3+2]=g/255})}i.setAttribute("color",new Bt(l,3))}Array.isArray(y.meshObject.material)?y.meshObject.material.forEach(r=>{r.vertexColors=!0,r.needsUpdate=!0}):(y.meshObject.material.vertexColors=!0,y.meshObject.material.needsUpdate=!0),L("legend-min").textContent=(y.facePenMin||0).toFixed(0)+" mm",L("legend-mid").textContent=((y.facePenMin+y.facePenMax)/2||0).toFixed(0)+" mm",L("legend-max").textContent=(y.facePenMax||0).toFixed(0)+" mm";const t=document.createElement("canvas");t.width=80,t.height=8;const n=t.getContext("2d"),s=n.createLinearGradient(0,0,80,0);s.addColorStop(0,"#1eb848"),s.addColorStop(.5,"#f5c542"),s.addColorStop(1,"#e82e1a"),n.fillStyle=s,n.fillRect(0,0,80,8),L("legend-gradient").style.background=`url(${t.toDataURL()})`,L("heatmap-legend").classList.remove("hidden"),y.result&&fo(y.meshObject,y.result.bestOrientation.theta*fn,y.result.bestOrientation.phi*fn,300)}else Array.isArray(y.meshObject.material)?y.meshObject.material.forEach(t=>{t.color.setHex(3900150),t.vertexColors=!1,t.needsUpdate=!0}):(y.meshObject.material.color.setHex(3900150),y.meshObject.material.vertexColors=!1,y.meshObject.material.needsUpdate=!0);(e=y.renderScene)==null||e.call(y)}function Kg(){var t;if(!(y.compareMode||!y.meshObject||!y.result)){po();var i=y.result.bestOrientation;y.meshObject.rotation.x=i.theta*fn,y.meshObject.rotation.y=i.phi*fn,y.meshObject.material.transparent=!1,y.meshObject.material.opacity=1,y.meshObject.material.depthWrite=!0,y.meshObject.material.vertexColors||y.meshObject.material.color.setHex(3900150),y.meshObject.material.needsUpdate=!0;var e=y.meshObject.material.clone();e.color.setHex(16739125),e.vertexColors=!1,e.transparent=!0,e.opacity=.35,e.depthWrite=!1,y.meshClone=new ut(y.meshObject.geometry,e),y.meshClone.position.copy(y.meshObject.position),y.meshClone.rotation.set(0,0,0),y.scene.add(y.meshClone),y.compareMode=!0,L("compare-info").classList.remove("hidden"),(t=y.renderScene)==null||t.call(y)}}function po(){var e;if(!!y.compareMode){if(y.compareMode=!1,y.meshClone&&(y.scene.remove(y.meshClone),y.meshClone.material.dispose(),y.meshClone=null),L("compare-info").classList.add("hidden"),y.meshObject&&y.result){var i=y.result.bestOrientation;y.meshObject.rotation.x=i.theta*fn,y.meshObject.rotation.y=i.phi*fn,y.meshObject.material.transparent=!1,y.meshObject.material.opacity=1,y.meshObject.material.depthWrite=!0,y.meshObject.material.needsUpdate=!0}(e=y.renderScene)==null||e.call(y)}}function Ys(i){y.viewMode=i,Nt(".vp-mode-btn").forEach(function(e){e.classList.toggle("active",e.dataset.mode===i)}),L("heatmap-legend").classList.add("hidden"),po(),i==="3d"&&y.meshObject&&(Array.isArray(y.meshObject.material)?y.meshObject.material.forEach(function(e){e.color.setHex(3900150),e.vertexColors=!1,e.needsUpdate=!0}):(y.meshObject.material.color.setHex(3900150),y.meshObject.material.vertexColors=!1,y.meshObject.material.needsUpdate=!0),y.result&&fo(y.meshObject,y.result.bestOrientation.theta*fn,y.result.bestOrientation.phi*fn,300)),i==="heatmap"&&Tc(),i==="compare"&&Kg()}function Ac(){var N;wc(),y.beamGroup=new Ci;var i=parseFloat(L("cfg-sod").value)||700,e=parseFloat(L("cfg-sdd").value)||1e3,t=parseFloat(L("cfg-detw").value)||400,n=parseFloat(L("cfg-deth").value)||400,s=e-i,r=-100;y.meshObject&&y.meshObject.geometry.boundingBox&&(r=y.meshObject.geometry.boundingBox.min.y);var a=new I(-i,0,0),o=new I(s,0,0);function l(H,G,ee,te){return new uc({color:H,roughness:te||.7,metalness:ee||.3,transparent:!0,opacity:G||.5,depthWrite:!1})}function c(H,G){return new rs({color:H,transparent:!0,opacity:G||1,depthWrite:!1})}var u=r-120,f=new ut(new Vn(1200,6,700),c(1580584,.1));f.position.y=u,y.beamGroup.add(f);var h=100,m=300,g=-i-60,S=new ut(new Ii(h,h,m,20),l(2766149,.4,.3,.7));S.rotation.z=Math.PI/2,S.position.set((-i+g)/2,0,0),y.beamGroup.add(S);var p=new ut(new as(h,16,16,0,Math.PI*2,0,Math.PI/2),l(2766149,.45,.3,.7));p.position.set(-i,0,0),p.rotation.z=-Math.PI/2,y.beamGroup.add(p);var d=new ut(new lo(6,14,16),c(14708800,.55));d.position.set(-i+2,0,0),d.rotation.y=Math.PI/2,y.beamGroup.add(d);var M=[new I(s,-n/2,-t/2),new I(s,-n/2,t/2),new I(s,n/2,-t/2),new I(s,n/2,t/2)],T=new Fi({color:14708800,transparent:!0,opacity:.2});M.forEach(function(H){var G=new Mt().setFromPoints([a.clone(),H]);y.beamGroup.add(new Ga(G,T))});var A=[a.clone(),new I(0,0,0),o.clone()],P=new Ga(new Mt().setFromPoints(A),new wu({color:15228976,transparent:!0,opacity:.35,dashSize:4,gapSize:3}));P.computeLineDistances(),y.beamGroup.add(P);var b=new ut(new oo(4,10,8),c(15228976,.35));b.position.set(-i*.3,0,0),b.quaternion.setFromUnitVectors(new I(0,1,0),new I(1,0,0)),y.beamGroup.add(b);var C=new ut(new as(8,16,16),c(15228976,.7));C.position.copy(a),y.beamGroup.add(C);var x=new ut(new Ii(78,80,14,32),l(3820122,.5,.4,.6));x.position.set(0,r-8,0),y.beamGroup.add(x);var w=new ut(new Ii(24,30,12,16),l(3820122,.5,.4,.6));w.position.set(0,r-15,0),y.beamGroup.add(w);var U=new ut(new Vn(80,n+80,t+80),l(1582133,.4,.1,.7));U.position.copy(o),y.beamGroup.add(U);var R=new ut(new Bi(t,n),new rs({color:3502288,transparent:!0,opacity:.3,side:Qt,depthWrite:!1}));R.position.set(s-39,0,0),R.quaternion.setFromUnitVectors(new I(0,0,1),new I(-1,0,0)),y.beamGroup.add(R);var B=new ao(new xu(new Bi(t,n)),new Fi({color:4227296,transparent:!0,opacity:.6}));B.position.copy(R.position),B.quaternion.copy(R.quaternion),y.beamGroup.add(B);var X=o.y-u;if(X>0){var Y=new ut(new Vn(10,X,10),l(1976376,.2,.2,.7));Y.position.set(s,u+X/2,0),y.beamGroup.add(Y)}y.scene.add(y.beamGroup),y.beamGroup.visible=y.beamVisible,(N=y.renderScene)==null||N.call(y)}function wc(){var i;!y.beamGroup||(y.scene.remove(y.beamGroup),y.beamGroup.traverse(function(e){(e.isMesh||e.isLine||e.isLineSegments)&&(e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(function(t){t.dispose()}):e.material.dispose()))}),y.beamGroup=null,(i=y.renderScene)==null||i.call(y))}function Yr(i,e){var t=document.createElement("canvas");t.width=64,t.height=64;var n=t.getContext("2d");n.font="Bold 36px Inter, sans-serif",n.textAlign="center",n.textBaseline="middle",n.shadowColor="rgba(0,0,0,0.6)",n.shadowBlur=6,n.fillStyle=e,n.fillText(i,32,32);var s=new lc(t);s.needsUpdate=!0;var r=new rc({map:s,transparent:!0,depthWrite:!1,sizeAttenuation:!0}),a=new uu(r);return a.scale.set(30,30,1),a}function Rc(){var l;Cc(),y.labelsGroup=new Ci;var i=150,e=24,t=Yr("X","#e86060");t.position.set(i+e,0,0),y.labelsGroup.add(t);var n=Yr("Y","#60d060");n.position.set(0,i+e,0),y.labelsGroup.add(n);var s=Yr("Z","#6080e0");s.position.set(0,0,i+e),y.labelsGroup.add(s);var r=new as(3,8,8),a=new rs({color:8949920,transparent:!0,opacity:.5}),o=new ut(r,a);y.labelsGroup.add(o),y.scene.add(y.labelsGroup),y.labelsGroup.visible=y.labelsVisible,(l=y.renderScene)==null||l.call(y)}function Cc(){var i;!y.labelsGroup||(y.scene.remove(y.labelsGroup),y.labelsGroup.traverse(function(e){(e.isSprite||e.isMesh)&&(e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(function(t){t.dispose()}):e.material.dispose()))}),y.labelsGroup=null,(i=y.renderScene)==null||i.call(y))}function Zg(i,e,t,n){return window.go.main.App.CalcBeamParams(i,e,t,n)}function $g(i,e,t,n){return window.go.main.App.CalcEnergyRecommendation(i,e,t,n)}function Jg(i,e){return window.go.main.App.ComputeFaceHeatmap(i,e)}function Qg(){return window.go.main.App.GetFilters()}function e_(){return window.go.main.App.GetMaterials()}function t_(){return window.go.main.App.GetScannerPresets()}function Pc(){return window.go.main.App.GetVertexBuffer()}function n_(i,e){return window.go.main.App.LoadMeshFromBytes(i,e)}function Lc(){return window.go.main.App.PickAndLoadMesh()}function i_(i){return window.go.main.App.RunOptimization(i)}let Va="all";function Wa(){const i=L("mat-grid");i.innerHTML="";const e=y.mats.filter(t=>!(Va!=="all"&&t.cat!==Va));for(const t of e){const n=document.createElement("button");n.type="button",n.className="mat-item",n.dataset.id=t.id,y.materialID===t.id&&n.classList.add("active"),n.innerHTML=`<span class="mat-swatch" style="background:${t.color}"></span><span class="mat-name">${t.name}</span>`,n.addEventListener("click",()=>Dc(t.id)),i.appendChild(n)}}function Dc(i){y.materialID=i,Nt(".mat-item").forEach(n=>n.classList.toggle("active",n.dataset.id===i));const e=document.getElementById("mat-subtitle"),t=y.mats.find(n=>n.id===i);e&&t&&(e.textContent="\u2014 "+t.name),ii(),Kt()}function s_(i){Va=i,Wa()}function ii(){Zg(y.energy,y.tPct,y.filterID,y.materialID).then(i=>{const e=JSON.parse(i);e.error||(L("disp-energy").textContent=y.energy,L("disp-tmin").textContent=y.tPct.toFixed(2),L("pill-kev").textContent=y.energy+" keV",L("pill-tmin").textContent=y.tPct.toFixed(2)+"% Tmin",L("pill-eeff").textContent=e.eEff.toFixed(0)+" Eeff",L("acc-beam-val").textContent=e.eEff.toFixed(0)+" keV",e.filter?(L("filter-stats").hidden=!1,L("fs-eeff").textContent=e.filter.eEff.toFixed(1),L("fs-shift").textContent="+"+e.filter.eShift.toFixed(1),L("fs-flux").textContent=(e.filter.fluxRatio*100).toFixed(1)+"%",L("fs-hvl").textContent=e.filter.hvlCu.toFixed(2)+" mm"):L("filter-stats").hidden=!0)}).catch(()=>{})}function r_(){const i=L("filter-grid");i.innerHTML="";for(const e of y.filters){const t=document.createElement("button");t.type="button",t.className="filter-btn"+(y.filterID===e.id?" active":""),t.innerHTML=`<span class="fb-icon">${e.icon}</span><span class="fb-name">${e.name}</span>`,t.addEventListener("click",()=>a_(e.id)),i.appendChild(t)}}function a_(i){y.filterID=i,Nt(".filter-btn").forEach(t=>t.classList.toggle("active",t.textContent.includes(i)));const e=y.filters.find(t=>t.id===i);L("acc-filter-val").textContent=e?e.name:"None",ii(),Kt()}function Fl(i,e){var t=null;return function(){var n=arguments,s=this;t&&clearTimeout(t),t=setTimeout(function(){t=null,i.apply(s,n)},e)}}function o_(){const i=L("sl-energy");var e=Fl(function(){ii(),Kt()},80);i.addEventListener("input",()=>{y.energy=parseFloat(i.value),e()}),[30,50,76,100,150,200,300].forEach(o=>{const l=document.createElement("button");l.textContent=o,l.addEventListener("click",()=>{i.value=o,y.energy=o,ii()}),L("presets-energy").appendChild(l)});const t=L("sl-tmin");var n=Fl(function(){ii(),Kt()},80);t.addEventListener("input",()=>{y.tPct=parseFloat(t.value),n()}),[.01,.05,.1,.2,.5,1,2].forEach(o=>{const l=document.createElement("button");l.textContent=o.toFixed(2),l.addEventListener("click",()=>{t.value=o,y.tPct=o,ii()}),L("presets-tmin").appendChild(l)});const s=L("sl-raygrid");function r(o){const l=o===0?8:o,c=Math.min(l*2,32),u=o<=8?"~10s-1m":o<=16?"~20s-2m":"~1-5m";L("grid-info").textContent=l+"\xD7"+l+" coarse / "+c+"\xD7"+c+" fine \xB7 "+u,L("grid-info").classList.remove("hidden")}s&&s.addEventListener("input",()=>{const o=parseInt(s.value);if(y.rayGridXY=o,o===0)L("disp-raygrid").textContent="default",L("disp-raygrid-hint").textContent="8\xD78 coarse / 16\xD716 fine (default)";else{L("disp-raygrid").textContent=o+"\xD7"+o;const l=Math.min(o*2,32);L("disp-raygrid-hint").textContent=o+"\xD7"+o+" coarse / "+l+"\xD7"+l+" fine"}r(o),Kt()});const a=L("cfg-searchrange");a&&(a.addEventListener("input",()=>{const o=parseInt(a.value,10)||45;y.searchRange=o,L("disp-searchrange").textContent=o+"\xB0";try{localStorage.setItem("penopt-search-range",String(o))}catch{}Kt()}),L("disp-searchrange").textContent=y.searchRange+"\xB0",a.value=y.searchRange)}function l_(){["cfg-sdd","cfg-sod","cfg-detw","cfg-deth","cfg-px","cfg-py"].forEach(function(i){var e=L(i);!e||e.addEventListener("change",Kt)})}function c_(){const i=L("scanner-preset");for(const e of y.presets){const t=document.createElement("option");t.value=e.id,t.textContent=e.name,i.appendChild(t)}i.addEventListener("change",()=>{const e=y.presets.find(n=>n.id===i.value);if(!e)return;L("cfg-sdd").value=e.sdd,L("cfg-sod").value=e.sod,L("cfg-detw").value=e.detWidth,L("cfg-deth").value=e.detHeight,L("cfg-px").value=e.pixelsX,L("cfg-py").value=e.pixelsY;const t=L("acc-scanner-val");t&&(e.id!=="custom"?t.textContent=e.name:t.textContent=e.sdd+"/"+e.sod),Kt()}),l_()}function h_(){const i=L("drop-zone");i.addEventListener("click",async()=>{try{const e=await Lc();e&&Ic(e)}catch(e){hn("File picker error: "+e)}}),L("file-input").addEventListener("change",()=>{L("file-input").files[0]&&jr(L("file-input").files[0])}),i.addEventListener("dragover",e=>{e.preventDefault(),i.classList.add("dragover")}),i.addEventListener("dragleave",()=>i.classList.remove("dragover")),i.addEventListener("drop",e=>{e.preventDefault(),i.classList.remove("dragover"),e.dataTransfer.files[0]&&jr(e.dataTransfer.files[0])}),L("viewport").addEventListener("dragover",e=>e.preventDefault()),L("viewport").addEventListener("drop",e=>{e.preventDefault(),e.dataTransfer.files[0]&&jr(e.dataTransfer.files[0])}),L("btn-remove").addEventListener("click",u_)}async function jr(i){var s,r;L("vp-loading").classList.remove("hidden"),L("idle-prompt").style.display="none",pn("Reading file...");const e=i.name.slice(i.name.lastIndexOf(".")).toLowerCase();if(e!==".stl"&&e!==".obj"){hn("Unsupported format"),L("vp-loading").classList.add("hidden");return}try{const a=await i.arrayBuffer(),o=await n_(i.name,Array.from(new Uint8Array(a)));if(!o){hn("Failed to parse mesh"),L("vp-loading").classList.add("hidden");return}y.meshInfo=o,y.meshLoaded=!0;const l=await Pc();Ec(l),Ac(),y.beamGroup&&(y.beamGroup.visible=!1),L("fm-name").textContent=i.name,L("fm-tris").textContent=o.numTriangles.toLocaleString()+" triangles",L("fm-bbox").textContent=`${o.boundsMinX.toFixed(0)}..${o.boundsMaxX.toFixed(0)}`,L("file-meta").classList.remove("hidden"),L("drop-zone").classList.add("hidden"),L("grid-info").classList.remove("hidden");const c=L("fm-dot"),u=L("fm-wt"),f=L("wt-banner"),h=L("wt-sidebar-row"),m=L("wt-sidebar-text");o.isWatertight?(c.className="dot dot--green",u.textContent="watertight",f.classList.add("hidden"),h.classList.add("hidden")):(c.className="dot dot--amber",u.textContent=`${o.boundaryEdges} boundary edges \u2014 non-watertight`,f.textContent="\u26A0 Mesh has open edges \u2014 results may be unreliable",f.classList.remove("hidden"),h.classList.remove("hidden"),m.textContent="Open edges \u2014 penetration values are underestimated"),L("os-text").textContent="Ready",L("os-dot").className="os-dot os-dot--ready",Xa({enabled:!0}),pn(`Loaded ${o.numTriangles.toLocaleString()} tris`),L("status-mesh").textContent=o.numTriangles.toLocaleString()+" tris",L("card-tradeoff").classList.add("tradeoff-disabled");const g=L("card-material"),S=L("card-optimize");if(g){var t=g.querySelector(".card-body");t&&(t.classList.add("no-animate"),t.style.maxHeight=""),g.classList.add("open"),(s=g.querySelector(".chevron"))==null||s.classList.add("open"),t&&requestAnimationFrame(function(){requestAnimationFrame(function(){t.classList.remove("no-animate")})})}if(S){var n=S.querySelector(".card-body");n&&(n.classList.add("no-animate"),n.style.maxHeight=""),S.classList.add("open"),(r=S.querySelector(".chevron"))==null||r.classList.add("open"),n&&requestAnimationFrame(function(){requestAnimationFrame(function(){n.classList.remove("no-animate")})})}L("vp-loading").classList.add("hidden"),Kt();try{localStorage.setItem("penopt-last-mesh",i.name)}catch{}}catch(a){hn("Load error: "+a.message),L("vp-loading").classList.add("hidden")}}async function Ic(i){var n,s;L("vp-loading").classList.remove("hidden"),L("idle-prompt").style.display="none",pn("Loading mesh..."),y.meshInfo=i,y.meshLoaded=!0;try{const r=await Pc();Ec(r),Ac(),y.beamGroup&&(y.beamGroup.visible=!1),L("fm-name").textContent=i.name,L("fm-tris").textContent=i.numTriangles.toLocaleString()+" triangles",L("fm-bbox").textContent=`${i.extentX.toFixed(0)} \xD7 ${i.extentY.toFixed(0)} \xD7 ${i.extentZ.toFixed(0)} mm`,L("file-meta").classList.remove("hidden"),L("drop-zone").classList.add("hidden"),L("grid-info").classList.remove("hidden");const a=L("fm-dot"),o=L("fm-wt"),l=L("wt-banner"),c=L("wt-sidebar-row"),u=L("wt-sidebar-text");i.isWatertight?(a.className="dot dot--green",o.textContent="watertight",l.classList.add("hidden"),c.classList.add("hidden")):(a.className="dot dot--amber",o.textContent=i.boundaryEdges+" boundary edges \u2014 non-watertight",l.textContent="\u26A0 Mesh has open edges \u2014 results may be unreliable",l.classList.remove("hidden"),c.classList.remove("hidden"),u.textContent="Open edges \u2014 penetration values are underestimated"),L("os-text").textContent="Ready",L("os-dot").className="os-dot os-dot--ready",Xa({enabled:!0}),pn("Loaded "+i.numTriangles.toLocaleString()+" tris"),L("status-mesh").textContent=i.numTriangles.toLocaleString()+" tris",L("card-tradeoff").classList.add("tradeoff-disabled");const f=L("card-material"),h=L("card-optimize");if(f){var e=f.querySelector(".card-body");e&&(e.classList.add("no-animate"),e.style.maxHeight=""),f.classList.add("open"),(n=f.querySelector(".chevron"))==null||n.classList.add("open"),e&&requestAnimationFrame(function(){requestAnimationFrame(function(){e.classList.remove("no-animate")})})}if(h){var t=h.querySelector(".card-body");t&&(t.classList.add("no-animate"),t.style.maxHeight=""),h.classList.add("open"),(s=h.querySelector(".chevron"))==null||s.classList.add("open"),t&&requestAnimationFrame(function(){requestAnimationFrame(function(){t.classList.remove("no-animate")})})}try{localStorage.setItem("penopt-last-mesh",i.name)}catch{}}catch(r){hn("Render error: "+r.message)}L("vp-loading").classList.add("hidden"),Kt()}async function u_(){var t;if(!await qc("Remove mesh and clear all results?"))return;y.meshObject&&(y.scene.remove(y.meshObject),y.meshObject.geometry.dispose(),y.meshObject.material.dispose(),y.meshObject=null),wc(),Cc(),po(),(t=y.renderScene)==null||t.call(y),y.meshLoaded=!1,y.meshInfo=null,y.result=null,y.facePenetrations=null,L("file-meta").classList.add("hidden"),L("drop-zone").classList.remove("hidden"),L("grid-info").classList.add("hidden"),L("results-panel").classList.add("hidden"),L("wt-banner").classList.add("hidden"),L("card-tradeoff").style.display="none",L("heatmap-legend").classList.add("hidden");const e=L("wt-sidebar-row");e&&e.classList.add("hidden"),[].slice.call(document.querySelectorAll(".result-warning")).forEach(n=>n.remove()),L("os-dot").className="os-dot os-dot--idle",L("os-text").textContent="Upload a mesh and select a material",Xa({enabled:!1,html:"\u25B6 <span>Optimize</span>"}),pn("Ready"),L("status-mesh").textContent="",L("idle-prompt").style.display="",Kr(),["card-material","card-optimize"].forEach(function(n){var a;const s=L(n);if(!!s){var r=s.querySelector(".card-body");r&&(r.classList.add("no-animate"),r.style.maxHeight=""),s.classList.remove("open"),(a=s.querySelector(".chevron"))==null||a.classList.remove("open"),r&&requestAnimationFrame(function(){requestAnimationFrame(function(){r.classList.remove("no-animate")})})}})}function Uc(i,e,t,n){const s=n||document.getElementById(i);if(!s)return{cv:null,ctx:null,w:0,h:0};const r=window.devicePixelRatio||1,a=s.parentElement.getBoundingClientRect(),o=Math.max(a.width-4,e),l=Math.max(t,100);s.width=o*r,s.height=l*r,s.style.width=o+"px",s.style.height=l+"px";const c=s.getContext("2d");return c.scale(r,r),{cv:s,ctx:c,w:o,h:l}}const Ol=Math.PI/180;function d_(i,e,t,n,s,r){const{ctx:a,w:o,h:l}=Uc("canvas-contour",236,176,s);if(!a)return;const c="#131519";a.fillStyle=c,a.fillRect(0,0,o,l);const u={l:32,r:24,t:10,b:22},f=o-u.l-u.r,h=l-u.t-u.b,m=[...new Set(i.map(q=>q.theta))].sort((q,Q)=>q-Q),g=[...new Set(i.map(q=>q.phi))].sort((q,Q)=>q-Q);if(m.length<2||g.length<2){a.fillStyle="#6b7280",a.font="bold 11px sans-serif",a.textAlign="center",a.fillText("Not enough data",o/2,l/2);return}const S=new Map;for(const q of i)S.set(q.theta+","+q.phi,q.score);const p=[...new Set(i.map(q=>q.theta))].sort((q,Q)=>q-Q),d=[...new Set(i.map(q=>q.phi))].sort((q,Q)=>q-Q);if(p.length<2||d.length<2){a.fillStyle="#6b7280",a.font="bold 11px sans-serif",a.textAlign="center",a.fillText("Not enough evaluated angles",o/2,l/2);return}let M=1/0,T=-1/0;for(const q of i)q.score<M&&(M=q.score),q.score>T&&(T=q.score);const A=T-M||1;function P(q){let Q,ye,ke;if(q<=.5){const Ee=q/.5;Q=Math.round(20+Ee*200),ye=Math.round(80+Ee*140),ke=Math.round(200-Ee*40)}else{const Ee=(q-.5)/.5;Q=Math.round(220+Ee*35),ye=Math.round(220-Ee*200),ke=Math.round(160-Ee*140)}return"#"+[Q,ye,ke].map(Ee=>Math.max(0,Math.min(255,Ee)).toString(16).padStart(2,"0")).join("")}const b=Math.min(...m),C=Math.max(...m),x=Math.min(...g),w=Math.max(...g),U=C-b||1,R=w-x||1;function B(q,Q){const ye=Math.min(C,Math.max(b,q)),ke=Math.min(w,Math.max(x,Q));let Ee=0;for(let Je=0;Je<p.length-1;Je++)if(ye>=p[Je]&&ye<=p[Je+1]){Ee=Je;break}let Z=0;for(let Je=0;Je<d.length-1;Je++)if(ke>=d[Je]&&ke<=d[Je+1]){Z=Je;break}const he=p[Ee],se=p[Ee+1],Ae=d[Z],De=d[Z+1],Pe=S.get(he+","+Ae)||M,st=S.get(se+","+Ae)||M,ze=S.get(he+","+De)||M,Ze=S.get(se+","+De)||M,je=(ye-he)/(se-he||1),Ue=(ke-Ae)/(De-Ae||1);return(Pe*(1-je)+st*je)*(1-Ue)+(ze*(1-je)+Ze*je)*Ue}const X=4;for(let q=0;q<p.length-1;q++)for(let Q=0;Q<d.length-1;Q++){const ye=p[q],ke=p[q+1],Ee=d[Q],Z=d[Q+1];for(let he=0;he<X;he++)for(let se=0;se<X;se++){const Ae=ye+(ke-ye)*(he+.5)/X,De=Ee+(Z-Ee)*(se+.5)/X,st=(B(Ae,De)-M)/A,ze=u.l+(Ae-b)/U*f,Ze=u.t+(1-(De-x)/R)*h,je=(ke-ye)/U*f/X+.5,Ue=(Z-Ee)/R*h/X+.5;a.fillStyle=P(st),a.fillRect(ze-je/2,Ze-Ue/2,je,Ue)}}const Y=o-18,N=8,H=h;for(let q=0;q<H;q++){const Q=1-q/H;a.fillStyle=P(Q),a.fillRect(Y,u.t+q,N,1)}if(a.strokeStyle="#383d49",a.lineWidth=.5,a.strokeRect(Y,u.t,N,H),a.fillStyle="#c8ccd4",a.font="10px sans-serif",a.textAlign="left",a.textBaseline="middle",a.fillText(M.toFixed(3),Y+N+3,u.t),a.fillText(((M+T)/2).toFixed(3),Y+N+3,u.t+H/2),a.fillText(T.toFixed(3),Y+N+3,u.t+H),e){const q=u.l+(e.theta-b)/U*f,Q=u.t+(1-(e.phi-x)/R)*h;a.strokeStyle="#ffffff",a.lineWidth=2,a.beginPath(),a.arc(q,Q,6,0,Math.PI*2),a.stroke(),a.fillStyle="#ffffff",a.font="bold 10px sans-serif",a.textAlign="left",a.textBaseline="bottom",a.fillText(e.score.toFixed(3),q+9,Q-2),a.font="9px sans-serif",a.fillStyle="#9ca3af",a.fillText("best",q+9,Q+10)}if(t&&t!==e){const q=u.l+(t.theta-b)/U*f,Q=u.t+(1-(t.phi-x)/R)*h;a.strokeStyle="rgba(255,255,255,0.8)",a.lineWidth=1.5;const ye=5;a.beginPath(),a.moveTo(q-ye,Q-ye),a.lineTo(q+ye,Q+ye),a.moveTo(q+ye,Q-ye),a.lineTo(q-ye,Q+ye),a.stroke(),a.fillStyle="rgba(255,255,255,0.7)",a.font="9px sans-serif",a.textAlign="left",a.textBaseline="top",a.fillText("worst",q+7,Q-3)}a.fillStyle="#9ca3af",a.font="10px sans-serif",a.textAlign="center",a.textBaseline="top";const G=p.filter((q,Q,ye)=>Q===0||Q===ye.length-1||Math.abs(q-ye[Q-1])>8);for(const q of G){const Q=u.l+(q-b)/U*f;a.fillText(q+"\xB0",Q,l-20)}a.textAlign="right",a.textBaseline="middle";const ee=d.filter((q,Q,ye)=>Q===0||Q===ye.length-1||Math.abs(q-ye[Q-1])>8);for(const q of ee){const Q=u.t+(1-(q-x)/R)*h;a.fillText(q+"\xB0",u.l-5,Q)}a.fillStyle="#6b7280",a.font="10px sans-serif",a.textAlign="center",a.textBaseline="bottom",a.fillText("\u03B8 (tilt)",o/2-u.r/2,l-3),a.save(),a.translate(7,u.t+h/2),a.rotate(-Math.PI/2),a.textAlign="center",a.textBaseline="bottom",a.fillText("\u03C6 (rotation)",0,0),a.restore();const te=r&&r.searchRange>0?r.searchRange:45,de=r&&r.constrainedOptimum;if(a.save(),a.strokeStyle=de?"rgba(245,158,11,0.7)":"rgba(255,255,255,0.12)",a.lineWidth=de?1.5:.8,a.setLineDash(de?[4,4]:[3,5]),b<=te&&C>=-te){const q=u.l+(-te-b)/U*f,Q=u.l+(te-b)/U*f;q>u.l&&(a.beginPath(),a.moveTo(q,u.t),a.lineTo(q,u.t+h),a.stroke()),Q<u.l+f&&(a.beginPath(),a.moveTo(Q,u.t),a.lineTo(Q,u.t+h),a.stroke())}if(x<=te&&w>=-te){const q=u.t+(1-(-te-x)/R)*h,Q=u.t+(1-(te-x)/R)*h;q>u.t&&(a.beginPath(),a.moveTo(u.l,q),a.lineTo(u.l+f,q),a.stroke()),Q<u.t+h&&(a.beginPath(),a.moveTo(u.l,Q),a.lineTo(u.l+f,Q),a.stroke())}a.setLineDash([]),a.restore(),n&&(a.fillStyle="#e8a838",a.font="bold 9px sans-serif",a.textAlign="center",a.textBaseline="top",a.fillText("\u26A0 Partial results",o/2,1))}function Nc(i,e,t,n,s){const{ctx:r,w:a,h:o}=Uc("canvas-rose",236,176,n);if(!r)return;r.fillStyle="#131519",r.fillRect(0,0,a,o);const l=a/2,c=o/2,u=Math.min(l,c)-24,f=u+10;if(!i||i.length<2){r.fillStyle="#6b7280",r.font="bold 11px sans-serif",r.textAlign="center",r.fillText("No penetration data",l,c),r.font="9px sans-serif",r.fillStyle="#4b5563",r.fillText("Run optimization to generate",l,c+16);return}let h=0;for(const M of i)M>h&&(h=M);if(e)for(const M of e)M>h&&(h=M);h===0&&(h=1),r.strokeStyle="#272b35",r.lineWidth=.5,r.fillStyle="#6b7280",r.font="7px sans-serif",r.textAlign="left",r.textBaseline="middle";for(let M=.25;M<=1;M+=.25){const T=u*M;r.beginPath(),r.arc(l,c,T,0,Math.PI*2),r.stroke(),r.fillText((h*M).toFixed(0)+" mm",l+T+4,c)}for(let M=0;M<360;M+=45){const T=M*Ol-Math.PI/2;r.strokeStyle="#272b35",r.lineWidth=.5,r.beginPath(),r.moveTo(l,c),r.lineTo(l+Math.cos(T)*u,c+Math.sin(T)*u),r.stroke();const A=l+Math.cos(T)*f,P=c+Math.sin(T)*f;r.fillStyle="#6b7280",r.font="7px sans-serif",r.textAlign="center",r.textBaseline="middle";const C={0:{x:0,y:-2},45:{x:2,y:-2},90:{x:4,y:0},135:{x:2,y:2},180:{x:0,y:4},225:{x:-2,y:2},270:{x:-4,y:0},315:{x:-2,y:-2}}[M]||{x:0,y:0};r.fillText(M+"\xB0",A+C.x,P+C.y)}if(s&&s.length>0){r.strokeStyle="rgba(251,191,36,0.8)",r.lineWidth=1.5;for(const M of s){const T=M*Ol-Math.PI/2,A=u*.92,P=u*1.04;r.beginPath(),r.moveTo(l+Math.cos(T)*A,c+Math.sin(T)*A),r.lineTo(l+Math.cos(T)*P,c+Math.sin(T)*P),r.stroke()}}function m(M,T,A,P,b){if(!(!M||M.length<2)){r.beginPath();for(let C=0;C<M.length;C++){const x=C/M.length*Math.PI*2-Math.PI/2,w=M[C]/h*u,U=l+Math.cos(x)*w,R=c+Math.sin(x)*w;C===0?r.moveTo(U,R):r.lineTo(U,R)}r.closePath(),T&&(r.fillStyle=T,r.fill()),A&&(r.strokeStyle=A,r.lineWidth=P||1.5,r.setLineDash(b||[]),r.stroke(),r.setLineDash([]))}}e&&e!==i&&m(e,"rgba(239,68,68,0.06)","rgba(239,68,68,0.4)",1.2,[3,3]),m(i,"rgba(59,130,246,0.12)","#3b82f6",1.8,null);const g=i?i.length:0,S=e?e.length:0;g!==S&&g>0&&S>0&&(r.fillStyle="#e8a838",r.font="bold 8px sans-serif",r.textAlign="center",r.textBaseline="bottom",r.fillText("\u26A0 "+g+" vs "+S+" projections",l,o-48));const p=o-14;r.textAlign="left",r.textBaseline="middle";let d=10;r.fillStyle="#3b82f6",r.fillRect(d,p-3,12,2),r.fillStyle="#c8ccd4",r.font="7px sans-serif",r.fillText("Optimal ("+g+" proj)",d+16,p),d+=75,e&&e!==i&&(r.strokeStyle="rgba(239,68,68,0.5)",r.lineWidth=1.2,r.beginPath(),r.setLineDash([3,3]),r.moveTo(d,p),r.lineTo(d+12,p),r.stroke(),r.setLineDash([]),r.fillStyle="#c8ccd4",r.font="7px sans-serif",r.fillText("Worst ("+S+" proj)",d+16,p),d+=75),s&&s.length>0&&(r.strokeStyle="rgba(251,191,36,0.8)",r.lineWidth=1.5,r.beginPath(),r.moveTo(d,p),r.lineTo(d+12,p),r.stroke(),r.fillStyle="#c8ccd4",r.font="7px sans-serif",r.fillText("IntelliScan ("+s.length+")",d+16,p)),t&&(r.fillStyle="#e8a838",r.font="bold 9px sans-serif",r.textAlign="center",r.textBaseline="middle",r.fillText("\u26A0 Partial result",l,12))}function f_(i,e){e&&(e.textContent="\u2713 Saved!");const t=JSON.stringify({bestOrientation:i.bestOrientation,worstOrientation:i.worstOrientation,allScores:i.allScores,numEvaluations:i.allScores.length,isPartial:i.isPartial||!1,constrainedOptimum:i.constrainedOptimum||!1,boundaryWarning:i.boundaryWarning||null,coarseFineMismatch:i.coarseFineMismatch||!1,mismatchNote:i.mismatchNote||null,referenceOrientation:i.referenceOrientation||null,intelliScan:i.intelliScan||null,timestamp:new Date().toISOString()},null,2),n=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(n),r=document.createElement("a");r.href=s,r.download="orientation-results.json",document.body.appendChild(r),r.click(),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(s),1e3),e&&setTimeout(function(){e.textContent="\u2913 JSON"},1500)}function p_(i,e,t,n){var f;if(!i)return;n&&(n.textContent="\u2713 Saved!");const s=i.domElement,r=s.width,a=s.height,o=document.createElement("canvas");o.width=r,o.height=a+120;const l=o.getContext("2d");l.drawImage(s,0,0);const c=a;l.fillStyle="#111419",l.fillRect(0,c,r,120),l.fillStyle="#cdd5e0",l.font="14px system-ui, sans-serif",l.textAlign="left",l.textBaseline="top",l.fillText("PenOpt \u2014 CT Scan Orientation Optimizer",14,c+14);const u=e==null?void 0:e.bestOrientation;u&&(l.fillStyle="#3b82f6",l.font="bold 20px monospace",l.fillText(`\u03B8 = ${u.theta}\xB0   \u03C6 = ${u.phi}\xB0`,14,c+40),l.fillStyle="#cdd5e0",l.font="13px system-ui, sans-serif",l.fillText(`Score: ${u.score.toFixed(3)}  |  Energy: ${t||"--"}${e!=null&&e.constrainedOptimum?"  |  \u26A0 constrained optimum":""}`,14,c+68),l.fillStyle="#8b95a8",l.font="11px monospace",l.fillText(new Date().toLocaleString()+"  |  "+(((f=e==null?void 0:e.allScores)==null?void 0:f.length)||0)+" orientations evaluated",14,c+92)),o.toBlob(h=>{if(!h)return;const m=URL.createObjectURL(h),g=document.createElement("a");g.href=m,g.download="orientation-results.png",document.body.appendChild(g),g.click(),document.body.removeChild(g),setTimeout(()=>URL.revokeObjectURL(m),1e3)},"image/png"),n&&setTimeout(function(){n.textContent="\u2913 PNG"},1500)}const Ri=window.runtime;function ir(){if(!y.meshLoaded||y.searching)return;y.searching=!0,y.searchCancel=!1,Kr(),L("btn-optimize").disabled=!0,L("btn-optimize").innerHTML="\u25B6 Searching...",L("vp-progress").classList.remove("hidden"),L("results-panel").classList.remove("hidden"),L("progress-ring").classList.remove("hidden"),L("hud-rot").classList.remove("hidden"),L("os-dot").className="os-dot os-dot--searching",L("os-text").textContent="Searching...",L("progress-fill").style.width="0%",L("pr-fill").style.strokeDashoffset="100.53",pn("Grid search in progress...");const i=Xc[y.weightPreset];y._progressTickPending=!1,Ri.EventsOn("search:progress",function(e){y.searchCancel||(y._lastProgressData=e,y._progressTickPending||(y._progressTickPending=!0,requestAnimationFrame(function(){var a,o;y._progressTickPending=!1;var t=y._lastProgressData;if(!!t){L("progress-fill").style.width=t.pct+"%",L("pr-pct").textContent=Math.round(t.pct)+"%",L("progress-label").textContent=Math.round(t.pct)+"%",L("pr-info").textContent=t.label||"Evaluating...";var n=(a=t.label)==null?void 0:a.match(/θ=([\d.]+)/),s=(o=t.label)==null?void 0:o.match(/φ=([\d.]+)/);n&&s&&(L("hud-rot").innerHTML="\u03B8: "+n[1]+"\xB0 \u03C6: "+s[1]+"\xB0");var r=100.53-t.pct/100*100.53;L("pr-fill").style.strokeDashoffset=Math.max(0,r)}})))}),Ri.EventsOn("search:done",function(e){if(Ri.EventsOff("search:progress"),Ri.EventsOff("search:done"),y.searchCancel){Gs();return}if(e.error){hn("Optimization error: "+e.error),L("progress-ring").classList.add("hidden"),Gs();return}try{const s=JSON.parse(e.result);y.result=s,Kr(),g_(s),__(s);var t=s.bestOrientation&&s.bestOrientation.maxPerProjection,n=s.worstOrientation&&s.worstOrientation.maxPerProjection;t&&t.length>=2&&s.intelliScan&&Nc(t,n,s.isPartial,null,s.intelliScan.angles),L("progress-ring").classList.add("hidden"),x_(s)}catch(s){hn("Result parse error: "+s.message),L("progress-ring").classList.add("hidden")}Gs()}),i_({weights:[i.wMtl,i.wEnergy,i.wHdn,i.wTuy,i.wBh],method:y.method}).catch(function(e){y.searchCancel||hn("Failed to start search: "+e),Ri.EventsOff("search:progress"),Ri.EventsOff("search:done"),L("progress-ring").classList.add("hidden"),Gs()})}function Gs(){y.searching=!1,L("btn-optimize").disabled=!1,L("btn-optimize").innerHTML="\u25B6 <span>Optimize</span>",L("vp-progress").classList.add("hidden"),L("hud-rot").classList.add("hidden"),L("os-dot").className="os-dot os-dot--ready",L("os-text").textContent=y.searchCancel?"Cancelled":"Complete",pn(y.searchCancel?"Search cancelled":"Optimization complete");var i=L("btn-update-search");i&&(i.textContent="Update Search",i.style.opacity="")}function m_(){y.searchCancel=!0,pn("Cancelling...")}function g_(i){const e=i.bestOrientation,t=i.worstOrientation,n=i.allScores.find(b=>b.theta===e.theta&&b.phi===e.phi),s=i.allScores.find(b=>b.theta===t.theta&&b.phi===t.phi);if(!n||!s)return;L("rs-angle").textContent=`\u03B8=${e.theta}\xB0 \u03C6=${e.phi}\xB0`;const r=(n.fMtl-s.fMtl)/s.fMtl*100,a=(n.fEnergy-s.fEnergy)/s.fEnergy*100;L("rs-fmtl").textContent=Math.abs(r).toFixed(1)+"% better",L("rs-fmtl").style.color=r<0?"var(--green-500)":"var(--text)",L("rs-fenergy").textContent=Math.abs(a).toFixed(1)+"% better",L("rs-fenergy").style.color=a<0?"var(--green-500)":"var(--text)";var o=i.allScores.length,l=i.numCoarseEval||0,c=i.numFineEval||0,u=i.searchTimeMs.toFixed(0)+"ms";i.coarseTimeMs&&(u=i.coarseTimeMs.toFixed(0)+"+"+i.fineTimeMs.toFixed(0)+"ms");var f=L("rs-tuy");if(f){var h=n.fTuy!==void 0?n.fTuy*100:null;h!==null&&(f.textContent=h.toFixed(0)+"%",f.style.color=h>90?"var(--green-500)":h>=70?"var(--amber-300)":"var(--red-500)")}L("rs-evals").textContent=o+" orientations ("+u+")",L("rs-evals").parentElement.title=l+" coarse + "+c+" fine | "+i.searchTimeMs.toFixed(0)+"ms total",L("opt-angles").textContent=`\u03B8 = ${e.theta}\xB0  \u03C6 = ${e.phi}\xB0`;const m=(b,C)=>{if(!C)return"--";const x=(b-C)/C*100;return(x>=0?"+":"")+x.toFixed(1)+"%"},g=b=>b<0?'style="color:var(--green-500)"':"";var S=n.fTuy!==void 0?(n.fTuy*100).toFixed(1)+"%":"--",p=s.fTuy!==void 0?(s.fTuy*100).toFixed(1)+"%":"--",d=n.fTuy!==void 0&&s.fTuy!==void 0?((n.fTuy-s.fTuy)*100/(s.fTuy||1)).toFixed(1)+"%":"--";const M=[["f_mtl",s.fMtl.toFixed(3),n.fMtl.toFixed(3),m(n.fMtl,s.fMtl),n.fMtl-s.fMtl],["f_energy",s.fEnergy.toFixed(1)+" mm",n.fEnergy.toFixed(1)+" mm",m(n.fEnergy,s.fEnergy),n.fEnergy-s.fEnergy],["f_hdn",s.fHdn.toFixed(3),n.fHdn.toFixed(3),m(n.fHdn,s.fHdn),n.fHdn-s.fHdn],["f_tuy",p,S,d,n.fTuy-s.fTuy]];L("opt-table-body").innerHTML=M.map(b=>`<tr><td>${b[0]}</td><td>${b[1]}</td><td>${b[2]}</td><td ${g(b[4])}>${b[3]}</td></tr>`).join("");var T=L("tuy-warning");if(n.fTuy!==void 0&&n.fTuy<.9){var h=(n.fTuy*100).toFixed(0);T||(T=document.createElement("div"),T.id="tuy-warning",T.style.cssText="margin-top:8px;padding:6px 8px;background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.3);border-radius:4px;font-size:10px;color:var(--amber-500);display:flex;align-items:center;gap:6px",L("opt-angles").parentElement.appendChild(T)),T.innerHTML="\u26A0 Only "+h+"% of faces satisfy Tuy-Smith condition \u2014 cone-beam artifacts may occur",T.style.display=""}else T&&(T.style.display="none");$g(y.materialID,n.fEnergy,y.tPct).then(b=>{const C=JSON.parse(b);if(C.error)return;L("energy-val").textContent=C.kv+" kV",L("rs-energy").textContent=C.kv+" kV";let x,w;C.kv<100?(x="\u25B2 Higher kV recommended",w="var(--amber-500)"):C.kv<=200?(x="Medium kV suitable",w="var(--text)"):(x="\u25BC Lower kV sufficient",w="var(--green-500)"),L("energy-qual").innerHTML=`<span style="color:${w}">${x}</span>`;const U=((1-n.fEnergy/s.fEnergy)*100).toFixed(0);L("energy-savings").textContent="~"+U+"% less energy than worst orientation",L("energy-caveat").textContent="Qualitative estimate. Actual consumption depends on scanner hardware."}).catch(()=>{}),y.meshObject&&fo(y.meshObject,e.theta*fn,e.phi*fn),d_(i.allScores,e,t,i.isPartial);var A=n&&n.maxPerProjection,P=s&&s.maxPerProjection;Nc(A,P,i.isPartial,null,null),L("card-tradeoff").style.display="",L("card-tradeoff").classList.remove("tradeoff-disabled"),y.facePenetrations=null,L("results-panel").classList.remove("hidden")}function __(i){var e=L("card-intelliscan"),t=L("intelliscan-body");if(!(!e||!t)){if(!i.intelliScan||!i.intelliScan.angles||i.intelliScan.angles.length===0){e.style.display="none";return}e.style.display="";var n=i.intelliScan,s=((1-n.count/360)*100).toFixed(0),r="";r+='<div class="is-summary">',r+='<div class="is-row"><span>Recommended projections:</span><strong>'+n.count+"</strong></div>",r+='<div class="is-row"><span>vs conventional 360\xB0:</span><strong>\u2212'+s+"% scan time</strong></div>",r+='<div class="is-row"><span>Computation:</span><span>'+n.elapsedMs.toFixed(0)+"ms on "+n.totalFaces.toLocaleString()+" faces</span></div>",r+="</div>",r+='<div class="is-table-wrap"><table class="is-table"><thead><tr><th>#</th><th>Angle \u03B1</th></tr></thead><tbody>',n.angles.forEach(function(l,c){r+="<tr><td>"+(c+1)+"</td><td>"+l.toFixed(1)+"\xB0</td></tr>"}),r+="</tbody></table></div>",r+='<div class="is-actions"><button class="is-btn" id="is-copy-btn">Copy angles</button><button class="is-btn" id="is-export-btn">Export JSON</button></div>',n.warning&&(r+='<div class="is-warning">\u2139 '+n.warning+"</div>"),r+='<div class="is-ref">Based on Butzhammer 2026 tangent-ray selection.</div>',r+='<div class="is-info" style="margin-top:6px;padding:4px 6px;background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.15);border-radius:4px;font-size:9px;color:var(--text-dim);line-height:1.4">Tangent angles computed for parallel-beam geometry. For wide-angle cone-beam systems (SOD/SDD &lt; 0.6), consider verifying critical angles manually.</div>',t.innerHTML=r;var a=document.getElementById("is-copy-btn");a&&(a.onclick=function(){var l=n.angles.map(function(c){return c.toFixed(1)}).join(", ");navigator.clipboard.writeText(l).then(function(){a.textContent="Copied!",setTimeout(function(){a.textContent="Copy angles"},1500)})});var o=document.getElementById("is-export-btn");o&&(o.onclick=function(){var l=JSON.stringify({intelliScanAngles:n.angles,count:n.count},null,2),c=new Blob([l],{type:"application/json"}),u=URL.createObjectURL(c),f=document.createElement("a");f.href=u,f.download="intelliscan-angles.json",document.body.appendChild(f),f.click(),document.body.removeChild(f),setTimeout(function(){URL.revokeObjectURL(u)},1e3)})}}async function x_(i){if(!y.meshInfo||!y.meshInfo.isWatertight)return;const e=i.bestOrientation;try{const t=await Jg(e.theta,e.phi),n=JSON.parse(t);if(n.error)return;y.facePenetrations=n;let s=1/0,r=-1/0;for(const a of n)a<s&&(s=a),a>r&&(r=a);y.facePenMin=s,y.facePenMax=r,y.viewMode==="heatmap"&&Tc()}catch(t){console.warn("Heatmap error:",t)}}function v_(){Nt(".card.accordion").forEach(i=>{const e=i.querySelector(".card-head"),t=i.querySelector(".card-body");!e||!t||(t.addEventListener("transitionend",function(s){s.propertyName==="max-height"&&i.classList.contains("open")&&(t.style.maxHeight="")}),e.addEventListener("click",()=>{const n=i.classList.contains("open");i.classList.toggle("open");const s=e.querySelector(".chevron");if(s&&s.classList.toggle("open"),n){t.style.maxHeight="";var r=t.scrollHeight;t.style.maxHeight=r+"px",requestAnimationFrame(function(){requestAnimationFrame(function(){t.style.maxHeight="0px"})})}else{t.style.maxHeight="";var a=t.scrollHeight;t.style.maxHeight="0px",requestAnimationFrame(function(){requestAnimationFrame(function(){t.style.maxHeight=a+"px"})})}}))})}function M_(){Nt(".acc-head").forEach(e=>{e.addEventListener("click",()=>{e.parentElement.classList.toggle("open")})});const i=document.querySelector(".acc");i&&i.classList.add("open")}function S_(){Nt(".tradeoff-stop").forEach(i=>{i.addEventListener("click",()=>{Nt(".tradeoff-stop").forEach(e=>e.classList.remove("active")),i.classList.add("active"),y.weightPreset=parseInt(i.dataset.w),Kt()})}),Nt(".method-btn").forEach(i=>{i.addEventListener("click",()=>{Nt(".method-btn").forEach(e=>e.classList.remove("active")),i.classList.add("active"),y.method=i.dataset.method,Kt()})}),L("btn-update-search").addEventListener("click",()=>{const i=L("btn-update-search");i.textContent="Updating...",i.style.opacity="0.7",ir();var e=setInterval(function(){y.searching||(i.textContent="Update Search",i.style.opacity="",clearInterval(e))},500)})}function y_(){L("btn-export").addEventListener("click",()=>{y.result&&f_(y.result,L("btn-export"))}),L("btn-export-png").addEventListener("click",()=>{var i;y.result&&p_(y.renderer,y.result,((i=L("energy-val"))==null?void 0:i.textContent)||"--",L("btn-export-png"))})}function b_(){Nt(".plot-tab").forEach(i=>{i.addEventListener("click",()=>{Nt(".plot-tab").forEach(e=>e.classList.remove("active")),Nt(".plot-content").forEach(e=>e.classList.remove("active")),i.classList.add("active"),L(`plot-${i.dataset.plot}`).classList.add("active")})})}(function(){var e=!1;function t(){var r=document.querySelectorAll("html, body, #sidebar, #results-content, #mat-grid, .is-table-wrap, .help-body, .acc-body");r.forEach(function(o){o.style.setProperty("scrollbar-width","thin","important"),o.style.setProperty("scrollbar-color",getComputedStyle(document.documentElement).getPropertyValue("--border-light").trim()||"#353850 "+(getComputedStyle(document.documentElement).getPropertyValue("--bg2").trim()||"#13151e"),"important")});var a=["html","body","#sidebar","#results-content","#mat-grid",".is-table-wrap",".help-body",".acc-body"];a.forEach(function(o){var l=document.querySelector(o);if(!!l){var c=l.style;c.setProperty("--sb-w","6px"),c.setProperty("--sb-h","6px")}})}function n(){document.body?(t(),e=!0):e||requestAnimationFrame(n)}if(document.addEventListener("DOMContentLoaded",n),document.readyState!=="loading"&&n(),typeof MutationObserver<"u"){var s=new MutationObserver(function(){!e&&document.body&&(t(),e=!0,s.disconnect())});s.observe(document.documentElement,{childList:!0,subtree:!0})}})();function E_(){document.addEventListener("keydown",i=>{var e,t,n,s;if(!(i.target.tagName==="INPUT"||i.target.tagName==="TEXTAREA"))switch(i.key){case"Escape":L("error-banner").classList.add("hidden"),L("help-overlay").classList.add("hidden");break;case"o":i.ctrlKey&&(i.preventDefault(),Lc().then(r=>{r&&Ic(r)}).catch(r=>hn("File picker error: "+r)));break;case"Enter":i.ctrlKey&&(i.preventDefault(),!((t=(e=L("btn-optimize"))==null?void 0:e.disabled)==null||t)&&!((s=(n=L("btn-optimize-sidebar"))==null?void 0:n.disabled)==null||s)&&ir());break;case"f":case"F":Fc();break;case"r":case"R":bc();break;case"1":Ys("3d");break;case"2":Ys("heatmap");break;case"3":Ys("compare");break}})}function Fc(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()}function T_(){L("btn-help").addEventListener("click",()=>L("help-overlay").classList.remove("hidden")),L("btn-help-close").addEventListener("click",()=>L("help-overlay").classList.add("hidden")),L("help-overlay").addEventListener("click",i=>{i.target===L("help-overlay")&&L("help-overlay").classList.add("hidden")})}L("btn-error-dismiss").addEventListener("click",()=>L("error-banner").classList.add("hidden"));function A_(){document.body.classList.add("js-tooltip-active");var i=null,e=null,t=document.createElement("div");t.style.cssText="position:fixed;top:-9999px;left:-9999px;visibility:hidden;padding:4px 8px;font-size:10px;font-weight:500;font-family:var(--font,Inter,sans-serif);line-height:1.4;max-width:300px;white-space:nowrap",document.body.appendChild(t);function n(l){t.textContent=l;var c=t.getBoundingClientRect();return{width:c.width,height:c.height}}function s(l){var c=document.createElement("div");return c.className="js-tooltip",c.textContent=l,c.style.cssText="position:fixed;top:-9999px;left:-9999px;padding:4px 8px;background:var(--surface,#1e2130);color:var(--text,#dde0ed);border:1px solid var(--border-light,#353850);border-radius:4px;font-size:10px;font-weight:500;font-family:var(--font,Inter,sans-serif);white-space:nowrap;pointer-events:none;z-index:9999;box-shadow:0 10px 20px rgba(0,0,0,0.45),0 4px 8px rgba(0,0,0,0.3);line-height:1.4;opacity:0;max-width:300px;overflow:hidden;text-overflow:ellipsis",document.body.appendChild(c),c}function r(l,c,u){var f=n(u),h=f.width,m=f.height,g=c.getBoundingClientRect(),S=6,p=window.innerWidth,d=window.innerHeight,M=g.top-S,T=d-g.bottom-S,A;M>=m?A=g.top-m-S:T>=m?A=g.bottom+S:A=M>=T?g.top-m-S:g.bottom+S;var P=g.left+g.width/2-h/2,b=Math.max(4,Math.min(P,p-h-4));b===4&&P<4?b=Math.max(4,g.left+4):b===p-h-4&&P>p-h-4&&(b=Math.min(p-h-4,g.right-h-4)),l.style.left=b+"px",l.style.top=A+"px",l.style.opacity="1";var C=A<g.top?"bottom":"top",x=4,w=g.left+g.width/2-b,U=l.querySelector(".js-tip-arrow"),R=U||document.createElement("div");R.className="js-tip-arrow",R.style.cssText="position:absolute;pointer-events:none;z-index:1;"+(C==="bottom"?"bottom:-"+x*2+"px;left:"+w+"px;border:"+x+"px solid transparent;border-top-color:var(--border-light,#353850)":"top:-"+x*2+"px;left:"+w+"px;border:"+x+"px solid transparent;border-bottom-color:var(--border-light,#353850)"),U||l.appendChild(R)}document.addEventListener("mouseenter",function(l){var c=l.target.closest("[data-tip]");if(!!c){var u=c.getAttribute("data-tip");!u||(i&&(i.remove(),i=null),i=s(u),e=c,r(i,c,u))}},!0),document.addEventListener("mouseleave",function(l){var c=l.target.closest("[data-tip]");!c||(i&&(i.remove(),i=null),e=null)},!0);var a=!1;function o(){a||(a=!0,requestAnimationFrame(function(){a=!1,i&&e&&document.body.contains(e)&&r(i,e,i.textContent)}))}window.addEventListener("scroll",o,{capture:!0,passive:!0}),window.addEventListener("resize",o,{passive:!0})}async function w_(){jg(),yc();try{const[a,o,l]=await Promise.all([e_(),Qg(),t_()]);y.mats=JSON.parse(a),y.filters=JSON.parse(o),y.presets=JSON.parse(l),Wa(),r_()}catch(a){hn("Failed to load database: "+a.message)}A_(),h_(),o_(),M_(),v_(),T_(),E_(),c_(),S_(),y_(),b_(),Nt(".mat-tab").forEach(a=>{a.addEventListener("click",()=>{Nt(".mat-tab").forEach(o=>o.classList.remove("active")),a.classList.add("active"),s_(a.dataset.cat)})}),L("mat-search").addEventListener("input",()=>{Wa()}),L("btn-optimize").addEventListener("click",ir),L("btn-optimize-sidebar").addEventListener("click",ir),L("btn-stop").addEventListener("click",m_),Nt(".vp-mode-btn").forEach(a=>a.addEventListener("click",()=>Ys(a.dataset.mode))),L("btn-reset-cam").addEventListener("click",bc),L("btn-fullscreen").addEventListener("click",Fc),L("btn-labels").addEventListener("click",function(){var a;y.labelsVisible=!y.labelsVisible,L("btn-labels").classList.toggle("active",y.labelsVisible),y.labelsGroup?(y.labelsGroup.visible=y.labelsVisible,(a=y.renderScene)==null||a.call(y)):Rc()}),L("btn-beam").addEventListener("click",function(){var a;y.beamVisible=!y.beamVisible,L("btn-beam").classList.toggle("active",y.beamVisible),y.beamGroup&&(y.beamGroup.visible=y.beamVisible,(a=y.renderScene)==null||a.call(y))}),Dc("al"),ii(),L("idle-prompt").style.display="",pn("Ready \u2014 drop a mesh file");const i=L("results-panel"),e=L("results-content"),t=L("results-collapse-btn");if(t&&i){y.resultsCollapsed&&(e.style.display="none",t.innerHTML="&#x25B2;",t.title="Expand results"),t.addEventListener("click",function(){y.resultsCollapsed=e.style.display!=="none",e.style.display=y.resultsCollapsed?"none":"",t.innerHTML=y.resultsCollapsed?"&#x25B2;":"&#x25BC;",t.title=y.resultsCollapsed?"Expand results":"Collapse results";try{localStorage.setItem("penopt-results-collapsed",y.resultsCollapsed?"1":"")}catch{}});try{localStorage.getItem("penopt-results-collapsed")==="1"&&(y.resultsCollapsed=!0);var n=localStorage.getItem("penopt-search-range");if(n!==null){var s=parseInt(n,10);if(!isNaN(s)&&s>=30&&s<=75){y.searchRange=s;var r=L("cfg-searchrange");r&&(r.value=s)}}}catch{}}}document.addEventListener("DOMContentLoaded",w_);
